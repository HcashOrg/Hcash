#ifndef hsrcore_lua_api_demo_h
#define hsrcore_lua_api_demo_h
    ...
    namespace api {
      ...
      public:
        ...
        */
        ...
        virtual std::shared_ptr<GluaModuleByteStream> get_bytestream_from_code(lua_State *L, const hsrcore::blockchain::Code& code);
        /**
        ...
        */
        ...
        /**
        * directly get storage value from hsrcore
        */
        //void free_contract_storage(lua_State *L, GluaStorageValue* storage);

        virtual GluaStorageValue get_storage_value_from_hsrcore(lua_State *L, const char *contract_name, std::string name);

        virtual GluaStorageValue get_storage_value_from_hsrcore_by_address(lua_State *L, const char *contract_address, std::string name);

        /**
        * after lua merge storage changes in lua_State, use the function to store the merged changes of storage to hsrcore
        */
        virtual bool commit_storage_changes_to_hsrcore(lua_State *L, AllContractsChangesMap &changes);
