...
namespace hsrcore {
    namespace net {
        ...
        public:
            ...
            hsrcore::blockchain::BlockIdType get_last_block_id()const;
            void                           set_last_block_id(const hsrcore::blockchain::BlockIdType& t);

            void exec_sync_loop();
            void set_database(hsrcore::blockchain::ChainDatabase*);
