/**
* some lib for hsrcore lua
* @author 
*/

#ifndef hsrcore_lua_lib_h
#define hsrcore_lua_lib_h
    ...
    namespace lua
    {
        namespace lib
        {
            ...
            public:
                ...
                /************************************************************************/
                /* check whether the hsrcore apis over limit(maybe hsrcore limit api called count) */
                /************************************************************************/
                int check_hsrcore_contract_api_instructions_over_limit();
            ...
            */
            ...
            /**
            * diff from execute_contract_api is the contract bytestream is loaded by pointer and hsrcore
            */
