...
namespace hsrcore {
    namespace wallet {
        ...
        struct PrettyTransaction
        {
            ...
            // transaction type
            fc::enum_type<hsrcore::blockchain::TransactionType, uint32_t>   trx_type = hsrcore::blockchain::TransactionType::normal_transaction;
...
FC_REFLECT(hsrcore::wallet::PublicKeySummary, (hex)(native_pubkey)(native_address)(pts_normal_address)(pts_compressed_address)(btc_normal_address)(btc_compressed_address))

FC_REFLECT(hsrcore::wallet::VoteSummary, (utilization)(negative_utilization)(up_to_date_with_recommendation))

FC_REFLECT(hsrcore::wallet::PrettyLedgerEntry,
(from_account)
(from_account_name)
(to_account)
(to_account_name)
...
FC_REFLECT(hsrcore::wallet::PrettyTransaction,
(is_virtual)
(is_confirmed)
(is_market)
(is_market_cancel)
...
FC_REFLECT(hsrcore::wallet::PrettyContractLedgerEntry,
(from_account)
(from_account_name)
(to_account)
(to_account_name)
...
FC_REFLECT(hsrcore::wallet::PrettyContractTransaction,
(result_trx_id)
(orig_trx_id)
(block_num)
(block_position)
...
FC_REFLECT(hsrcore::wallet::ContractTransactionSummary,
(result_trx_id)
(orig_trx_id)
(block_num)
(block_position)
...
FC_REFLECT(hsrcore::wallet::PrettyReserveBalance,
(balance_id)
(sharedrop_address)
(start_time)
(duration)
...
FC_REFLECT(hsrcore::wallet::EscrowSummary,
