...
FC_REFLECT(hsrcore::blockchain::ExtendedPublicKey, (pub_key)(chain_code))
FC_REFLECT(hsrcore::blockchain::ExtendedPrivateKey, (priv_key)(chain_code))
FC_REFLECT(hsrcore::blockchain::ExtendedAddress, (addr))

namespace fc
{
    void to_variant(const hsrcore::blockchain::ExtendedAddress& var, fc::variant& vo);
...
{
    template<>
    struct hash < hsrcore::blockchain::ExtendedAddress >
    {
    public:
        size_t operator()(const hsrcore::blockchain::ExtendedAddress &a) const
        {
            size_t s;
            fc::sha1::encoder enc;
            fc::raw::pack(enc, a);
