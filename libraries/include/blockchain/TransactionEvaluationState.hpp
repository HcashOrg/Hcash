...
namespace hsrcore {
    namespace blockchain {
        ...
        public:
            ...
            bool is_contract_op(const hsrcore::blockchain::OperationTypeEnum& op_type)const;
...
FC_REFLECT(hsrcore::blockchain::TransactionEvaluationState,
    (trx)
    (signed_keys)
    (validation_error)
    (deposits)
