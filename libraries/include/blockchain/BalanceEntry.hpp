    ...
    namespace blockchain {
        ...
        struct BalanceEntry
        {
            ...
            */
			...
			TransactionIdType		   last_update_transaction_id;
...
FC_REFLECT(hsrcore::blockchain::SnapshotEntry, (original_address)(original_balance))
FC_REFLECT(hsrcore::blockchain::BalanceEntry, (condition)(balance)(restricted_owner)(snapshot_info)(deposit_date)(last_update)(last_update_transaction_id)(meta_data))
