    ...
    namespace blockchain {
        ...
        public:
            ...
            */
			...
			bool				store_account_entries_for_sandbox(const vector<hsrcore::wallet::WalletAccountEntry>& vec_account_entry);
            /**
            ...
            */
			...
			std::vector<SignedTransaction> get_pending_transactions_original()const;
			...
			bool CheckStake(SignedBlockHeader& pblock);


			bool CheckProofOfStake(SignedBlockHeader& pblock_header, int nTimeSearch);
			...
			*/
			SignedBlockHeader GetLastBlockHeader(BlockIdType pindexLast, bool fProofOfStake);
            ...
            */
            ...
            /**  Fetch HSR input balance in blocks that block_num of them are lower of the given block_num
            *  or equal to
            *
            * @param  block_num  uint32_t
            *
            * @return vector<HSRTrxidBalance>
            */
            vector<HSRTrxidBalance> fetch_hsr_input_balance(const uint32_t &  block_num);

            /**  Insert the HSR transaction balance to db _hsr_input_balance_entry
            *
            * @param  hsr_account  string
            * @param  hsr_balance_entry  HSRTrxidBalance
            *
            * @return void
            */
            void transaction_insert_to_hsr_balance(const string & hsr_account, const HSRTrxidBalance & hsr_balance_entry);

            /** Erase the HSR transaction balance from db _hsr_input_balance_entry
            *
            * @param  hsr_account  string
            * @param  hsr_balance_entry  HSRTrxidBalance
            *
            * @return void
            */
            void transaction_erase_from_hsr_balance(const string & hsr_account, const HSRTrxidBalance & hsr_balance_entry);
            vector<HSRTrxidBalance> fetch_hsr_full_entry(const uint32_t& block_num, const uint32_t& last_scan_block_num);
            //Must handle account before you use this function
            void transaction_insert_to_hsr_full_entry(const string& hsr_accout, const HSRTrxidBalance& hsr_balance_entry);
            //Must handle account before you use this function
            void transaction_erase_from_hsr_full_entry(const string& hsr_accout, const HSRTrxidBalance& hsr_balance_entry);
            ...
            */
			...
			optional<fc::ripemd160> get_head_block_modify(const BlockIdType& id)const;
			void store_block_modify(const BlockIdType& id, const fc::ripemd160& entry);
        ...
        private:
            ...
            */
			...
			virtual optional<fc::ripemd160> modify_lookup_by_block_id(const BlockIdType&)const ;

			virtual void modify_insert_into_block_id_map(const BlockIdType&, const fc::ripemd160&);

			virtual void modify_erase_from_block_id_map(const BlockIdType&);
...
FC_REFLECT(hsrcore::blockchain::BlockForkData, (next_blocks)(is_linked)(is_valid)(invalid_reason)(is_included)(is_known))
FC_REFLECT(hsrcore::blockchain::ForkEntry, (block_id)(signing_delegate)(transaction_count)(latency)(size)(timestamp)(is_valid)(invalid_reason)(is_current_fork))
