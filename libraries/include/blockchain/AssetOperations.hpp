...
FC_REFLECT(hsrcore::blockchain::CreateAssetOperation,
    (symbol)
    (name)
    (description)
    (public_data)
    ...
    FC_REFLECT(hsrcore::blockchain::UpdateAssetOperation,
    (asset_id)
    (name)
    (description)
    (public_data)
    ...
    FC_REFLECT_DERIVED(hsrcore::blockchain::UpdateAssetExtOperation,
    (hsrcore::blockchain::UpdateAssetOperation),
    (flags)
    (issuer_permissions)
    (issuer_account_id)
    (transaction_fee)
    ...
    FC_REFLECT(hsrcore::blockchain::IssueAssetOperation,
    (amount)
    )
