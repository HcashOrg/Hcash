...
FC_REFLECT(hsrcore::blockchain::UpgradeContractOperation, (id)(name)(desc)(exec_limit)(transaction_fee)(balances))
FC_REFLECT(hsrcore::blockchain::DestroyContractOperation, (id)(exec_limit)(transaction_fee)(balances))
FC_REFLECT(hsrcore::blockchain::OnDestroyOperation, (id)(amount))
FC_REFLECT(hsrcore::blockchain::OnUpgradeOperation, (id)(name)(desc))
FC_REFLECT(hsrcore::blockchain::OnCallSuccessOperation, )
FC_REFLECT(hsrcore::blockchain::RegisterContractOperation, (contract_code)(initcost)(transaction_fee)(balances)(owner)(register_time))
FC_REFLECT(hsrcore::blockchain::CallContractOperation, (caller)(balances)(contract)(costlimit)(transaction_fee)(method)(args))
FC_REFLECT(hsrcore::blockchain::ContractInfoOperation, (contract_id)(owner)(code)(register_time))
FC_REFLECT(hsrcore::blockchain::TransferContractOperation, (from)(costlimit)(transaction_fee)(transfer_amount)(balances)(contract_id))
