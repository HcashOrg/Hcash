...
namespace hsrcore {
    namespace blockchain{
        ...
        struct Code
        {
            ...
            std::map<std::string, fc::enum_type<fc::unsigned_int, hsrcore::blockchain::StorageValueTypes>> storage_properties;
...
FC_REFLECT_ENUM(hsrcore::blockchain::ContractApiType,
    (chain)
    (offline)
    (event)
    )

    FC_REFLECT_ENUM(hsrcore::blockchain::ContractState,
    (valid)
    (deleted)
    )

    FC_REFLECT_ENUM(hsrcore::blockchain::ContractLevel,
    (temp)
    (forever)
    )


    FC_REFLECT(hsrcore::blockchain::Code,
    (abi)
    (offline_abi)
    (events)
    (storage_properties)
    ...
    FC_REFLECT(hsrcore::blockchain::CodePrintAble,
    (abi)
    (offline_abi)
    (events)
    ...
    FC_REFLECT(hsrcore::blockchain::ContractEntry,
    (contract_name)
    (id)
    (level)
    (owner)
    ...
    FC_REFLECT(hsrcore::blockchain::ContractStorageEntry, (id)(contract_storages))
	FC_REFLECT(hsrcore::blockchain::ResultTIdEntry, (res))
	FC_REFLECT(hsrcore::blockchain::RequestIdEntry, (req))
	FC_REFLECT(hsrcore::blockchain::ContractTrxEntry, (trx_id))
	FC_REFLECT(hsrcore::blockchain::ContractinTrxEntry, (contract_id))
