...
FC_REFLECT(hsrcore::blockchain::StorageDataChangeType, (storage_before)(storage_after))
FC_REFLECT(hsrcore::blockchain::StorageOperation, (contract_id)(contract_change_storages))
