...
FC_REFLECT_ENUM(hsrcore::blockchain::DepositContractType, (deposit_contract_normal)(deposit_contract_margin))
FC_REFLECT(hsrcore::blockchain::DepositContractOperation, (amount)(condition))
FC_REFLECT(hsrcore::blockchain::WithdrawOperation, (balance_id)(amount)(claim_input_data))
FC_REFLECT(hsrcore::blockchain::DepositOperation, (amount)(condition))
FC_REFLECT(hsrcore::blockchain::WithdrawContractOperation, (balance_id)(amount)(contract))
FC_REFLECT(hsrcore::blockchain::BalancesWithdrawOperation, (balances))
FC_REFLECT(hsrcore::blockchain::ReleaseEscrowOperation, (escrow_id)(released_by)(amount_to_receiver)(amount_to_sender))
FC_REFLECT(hsrcore::blockchain::UpdateBalanceVoteOperation, (balance_id)(new_restricted_owner)(new_slate))
