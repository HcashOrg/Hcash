...
FC_REFLECT_ENUM(hsrcore::blockchain::StorageValueTypes,
    (storage_value_null)
    (storage_value_int)
    ...
    FC_REFLECT(hsrcore::blockchain::StorageDataType,
    (storage_type)
    (storage_data)
    )

    FC_REFLECT(hsrcore::blockchain::StorageNullType,
    (raw_storage)
    )

    FC_REFLECT(hsrcore::blockchain::StorageIntType,
    (raw_storage)
    )

    FC_REFLECT(hsrcore::blockchain::StorageBoolType,
    (raw_storage)
    )

    FC_REFLECT(hsrcore::blockchain::StorageNumberType,
    (raw_storage)
    )

    FC_REFLECT(hsrcore::blockchain::StorageStringType,
    (raw_storage)
    )

    FC_REFLECT(hsrcore::blockchain::StorageIntTableType,
    (raw_storage_map)
    )

    FC_REFLECT(hsrcore::blockchain::StorageBoolTableType,
    (raw_storage_map)
    )

    FC_REFLECT(hsrcore::blockchain::StorageNumberTableType,
    (raw_storage_map)
    )

    FC_REFLECT(hsrcore::blockchain::StorageStringTableType,
    (raw_storage_map)
    )

    FC_REFLECT(hsrcore::blockchain::StorageIntArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(hsrcore::blockchain::StorageBoolArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(hsrcore::blockchain::StorageNumberArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(hsrcore::blockchain::StorageStringArrayType,
    (raw_storage_map)
    )
