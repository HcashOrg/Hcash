...
namespace fc
{
    void to_variant(const hsrcore::blockchain::PublicKeyType& var, fc::variant& vo);
    void from_variant(const fc::variant& var, hsrcore::blockchain::PublicKeyType& vo);
}

#include <fc/reflect/reflect.hpp>
FC_REFLECT(hsrcore::blockchain::PublicKeyType, (key_data))
FC_REFLECT(hsrcore::blockchain::PublicKeyType::BinaryKey, (data)(check));
FC_REFLECT_ENUM(hsrcore::blockchain::BlockchainSecurityState::alert_level_enum, (green)(yellow)(red)(grey));
FC_REFLECT(hsrcore::blockchain::BlockchainSecurityState, (alert_level)(estimated_confirmation_seconds)(participation_rate))
