...
namespace hsrcore {
    namespace blockchain {
        ...
        struct Price
        {
            ...
            fc::uint128_t ratio; // This is a DECIMAL FRACTION with denominator equal to HSR_PRICE_PRECISIONI
         ...
         *  denominator.  Therefore  hsrcore/usd and  usd/hsrcore will
         *  always result in a price measured in usd/hsrcore because
         ...
         *
         *  ie:  p = 3 usd/hsrcore & a = 4 hsrcore then result = 12 usd
         *  ie:  p = 3 usd/hsrcore & a = 4 usd then result = 1.333 hsrcore
         */
...
namespace fc
{
    //  void to_variant( const hsrcore::blockchain::asset& var,  variant& vo );
    //  void from_variant( const variant& var,  hsrcore::blockchain::asset& vo );
    void to_variant(const hsrcore::blockchain::Price& var, variant& vo);
    void from_variant(const variant& var, hsrcore::blockchain::Price& vo);
}

#include <fc/reflect/reflect.hpp>
FC_REFLECT(hsrcore::blockchain::Price, (ratio)(quote_asset_id)(base_asset_id));
FC_REFLECT(hsrcore::blockchain::Asset, (amount)(asset_id));
