...
namespace hsrcore {
    namespace rpc_stubs {
        class CommonApiClient : public hsrcore::api::CommonApi
        {
        protected:
            virtual hsrcore::api::CommonApi* get_impl() const = 0;
