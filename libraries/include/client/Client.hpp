...
namespace hsrcore {
    namespace client {
        ...
        //    using hsrcore::mail::mail_client_ptr;
        ...
        struct RpcServerConfig
        {
			...
			vector<std::string>      rpc_allow_ip;
			vector<std::string>      http_allow_ip;
        ...
        struct Config
        {
            ...
            ShareType          min_relay_fee = HSR_BLOCKCHAIN_DEFAULT_RELAY_FEE;
            string              wallet_callback_url;

            ShareType          light_network_fee = HSR_BLOCKCHAIN_DEFAULT_RELAY_FEE;
            ShareType          light_relay_fee = HSR_BLOCKCHAIN_DEFAULT_RELAY_FEE;
            ...
            optional<string>    growl_hsr_client_identifier;
         ...
         *
         */
        class Client : public hsrcore::rpc_stubs::CommonApiClient,
        ...
        public:
            ...
            hsrcore::rpc::RpcServerPtr   get_rpc_server()const;
            hsrcore::net::NodePtr         get_node()const;
            fc::path                   get_data_dir()const;

            // returns true if the client is connected to the network
            bool                is_connected() const;
            hsrcore::net::NodeIdType get_node_id() const;
            ...
            bool handle_message(const hsrcore::net::Message&, bool sync_mode);
            void sync_status(uint32_t item_type, uint32_t item_count);
            DelegateConfig get_delegate_config();
        protected:
            virtual hsrcore::api::CommonApi* get_impl() const override;
...
extern const std::string HSR_MESSAGE_MAGIC;

FC_REFLECT(hsrcore::client::ClientNotification, (timestamp)(message)(signature))
FC_REFLECT(hsrcore::client::RpcServerConfig, (enable)(enable_cache)(rpc_user)(rpc_password)(rpc_endpoint)(httpd_endpoint)
(encrypted_rpc_endpoint)(encrypted_rpc_wif_key)(htdocs))
FC_REFLECT(hsrcore::client::ChainServerConfig, (enabled)(listen_port))
FC_REFLECT(hsrcore::client::Config,
(logging)
(ignore_console)
(client_debug_name)
(rpc)
