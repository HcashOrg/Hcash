...
namespace hsrcore {
    namespace client {
        ...
        namespace detail {
            ...
            {
            public:
                typedef hsrcore::db::LevelMap<fc::time_point, fc::exception> ExceptionLeveldbType;
            private:
            ...
            public:
                void open(const fc::path& filename)
                {
                    ...
                    catch (const hsrcore::db::level_map_open_failure&)
                    {
            ...
            class ClientImpl : public hsrcore::net::NodeDelegate,
                public hsrcore::api::CommonApi
            {
            public:
				...
				ClientImpl(hsrcore::client::Client* self, const std::string& user_agent) :
					_self(self),
					...
					_blockchain_synopsis_size_limit((unsigned)(log2(HSR_BLOCKCHAIN_BLOCKS_PER_YEAR * 20))),
					...
					exit_stake_thread(0)
                {
                    try
                    {
                        if (hsrcore::lua::api::global_glua_chain_api == nullptr)
                            hsrcore::lua::api::global_glua_chain_api = new hsrcore::lua::api::GluaChainApi;
                ...
                */
				...
				hsrcore::blockchain::TransactionIdType network_broadcast_transactions(const std::vector<hsrcore::blockchain::SignedTransaction>& transactions_to_broadcast);
                ...
                // @{
				virtual bool has_item(const hsrcore::net::ItemId& id) override;
				fc::time_point_sec handle_ntp_time(bool need_update)override;
                virtual bool handle_message(const hsrcore::net::Message&, bool sync_mode) override;
                virtual std::vector<hsrcore::net::ItemHashType> get_item_ids(uint32_t item_type,
                    const vector<hsrcore::net::ItemHashType>& blockchain_synopsis,
                    uint32_t& remaining_item_count,
                    uint32_t limit = 2000) override;
                virtual hsrcore::net::Message get_item(const hsrcore::net::ItemId& id) override;
                virtual fc::sha256 get_chain_id() const override
                {
                    FC_ASSERT(_chain_db != nullptr);
                    return _chain_db->get_chain_id();
                }
                virtual std::vector<hsrcore::net::ItemHashType> get_blockchain_synopsis(uint32_t item_type,
                ...
                virtual uint32_t get_block_number(const hsrcore::net::ItemHashType& block_id) override;
                virtual fc::time_point_sec get_block_time(const hsrcore::net::ItemHashType& block_id) override;
                virtual fc::time_point_sec get_blockchain_now() override;
                virtual hsrcore::net::ItemHashType get_head_block_id() const override;
                ...
                hsrcore::client::Client*                                    _self;
                std::string                                             _user_agent;
                hsrcore::cli::Cli*                                          _cli = nullptr;
                ...
                hsrcore::rpc::RpcServerPtr                                _rpc_server = nullptr;
                std::unique_ptr<hsrcore::net::ChainServer>                 _chain_server = nullptr;
                std::unique_ptr<hsrcore::net::UpnpService>                 _upnp_service = nullptr;
                ...
                //  std::shared_ptr<hsrcore::mail::server>                      _mail_server = nullptr;
                // std::shared_ptr<hsrcore::mail::client>                      _mail_client = nullptr;
                ...
                hsrcore::net::NodePtr                                      _p2p_node = nullptr;
                bool                                                    _simulated_network = false;

                HSRGntpNotifierPtr                                   _notifier;
				...
				fc::time_point_sec										nHPSTimerStart;
				uint64_t												nBlockSize;
				uint64_t												nBlockTx;
				bool													fgenerate;
				bool													fposgenerate;
                ...
                // include all of the method overrides generated by the hsr_api_generator
