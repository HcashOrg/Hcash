...
namespace glua
{
	...
	public:
		...
		virtual std::shared_ptr<::blockchain::contract_engine::VMModuleByteStream> get_bytestream_from_code(const hsrcore::blockchain::Code& code);
	};
}
