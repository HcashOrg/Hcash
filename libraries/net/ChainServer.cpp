    ...
    namespace net {
        namespace detail {
            ...
            public:
                ...
                std::shared_ptr<hsrcore::blockchain::ChainDatabase> _chain_db;
                ...
                ChainServerImpl(std::shared_ptr<hsrcore::blockchain::ChainDatabase> chain_ptr, uint16_t port)
                    : _chain_db(chain_ptr),
        ...
        hsrcore::net::ChainServer::ChainServer(std::shared_ptr<hsrcore::blockchain::ChainDatabase> chain_ptr, uint16_t port)
        ...
        uint16_t hsrcore::net::ChainServer::get_listening_port()
        {
            return my->_server_socket.get_port();
        }

    }
} //namespace hsrcore::net
