...
static_assert((int)hsrcore::net::block_message_type == (int)hsrcore::client::block_message_type, "enum values don't match");
static_assert((int)hsrcore::net::trx_message_type == (int)hsrcore::client::trx_message_type, "enum values don't match");
