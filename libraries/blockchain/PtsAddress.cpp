...
namespace fc
{
    void to_variant(const hsrcore::blockchain::PtsAddress& var, variant& vo)
    {
        vo = std::string(var);
    }
    void from_variant(const variant& var, hsrcore::blockchain::PtsAddress& vo)
    {
        vo = hsrcore::blockchain::PtsAddress(var.as_string());
    }
}
