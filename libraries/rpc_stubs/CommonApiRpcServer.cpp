...
namespace hsrcore {
    namespace rpc_stubs {
        ...
        fc::variant CommonApiRpcServer::blockchain_get_hsr_account_balance_entry_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // this method has no prerequisites
            ...
            std::vector<hsrcore::blockchain::HSRTrxidBalance> result = get_client()->blockchain_get_hsr_account_balance_entry(block_num);
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::blockchain_get_hsr_account_balance_entry_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // this method has no prerequisites
        ...
        fc::variant CommonApiRpcServer::blockchain_calculate_supply_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::Asset result = get_client()->blockchain_calculate_supply(asset);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_security_state_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::BlockchainSecurityState result = get_client()->blockchain_get_security_state();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::AccountEntry> result = get_client()->blockchain_list_accounts(first_account_name, limit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_recently_updated_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::AccountEntry> result = get_client()->blockchain_list_recently_updated_accounts();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_recently_registered_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::AccountEntry> result = get_client()->blockchain_list_recently_registered_accounts();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_assets_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::AssetEntry> result = get_client()->blockchain_list_assets(first_symbol, limit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_pending_transactions_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<std::pair<hsrcore::blockchain::TransactionIdType, hsrcore::blockchain::SignedTransaction>> result = get_client()->blockchain_list_pending_transactions();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::pair<hsrcore::blockchain::TransactionIdType, hsrcore::blockchain::TransactionEntry> result = get_client()->blockchain_get_transaction(transaction_id_prefix, exact);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_pretty_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::PrettyTransaction result = get_client()->blockchain_get_pretty_transaction(transaction_id_prefix, exact);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_pretty_contract_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::PrettyContractTransaction result = get_client()->blockchain_get_pretty_contract_transaction(transaction_id_prefix, exact);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_block_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            fc::optional<hsrcore::blockchain::BlockEntry> result = get_client()->blockchain_get_block(block);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_block_transactions_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::map<hsrcore::blockchain::TransactionIdType, hsrcore::blockchain::TransactionEntry> result = get_client()->blockchain_get_block_transactions(block);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_account_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            fc::optional<hsrcore::blockchain::AccountEntry> result = get_client()->blockchain_get_account(account);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_slate_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::map<hsrcore::blockchain::AccountIdType, std::string> result = get_client()->blockchain_get_slate(slate);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::Address balance_id = parameters[0].as<hsrcore::blockchain::Address>();

            hsrcore::blockchain::BalanceEntry result = get_client()->blockchain_get_balance(balance_id);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_balance_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::Address balance_id = parameters["balance_id"].as<hsrcore::blockchain::Address>();
        ...
        fc::variant CommonApiRpcServer::blockchain_list_balances_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::unordered_map<hsrcore::blockchain::BalanceIdType, hsrcore::blockchain::BalanceEntry> result = get_client()->blockchain_list_balances(first_balance_id, limit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_address_balances_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::unordered_map<hsrcore::blockchain::BalanceIdType, hsrcore::blockchain::BalanceEntry> result = get_client()->blockchain_list_address_balances(addr, chanced_since);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_account_public_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::AccountBalanceSummaryType result = get_client()->blockchain_get_account_public_balance(account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_key_balances_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::PublicKeyType key = parameters[0].as<hsrcore::blockchain::PublicKeyType>();

            std::unordered_map<hsrcore::blockchain::BalanceIdType, hsrcore::blockchain::BalanceEntry> result = get_client()->blockchain_list_key_balances(key);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_key_balances_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::PublicKeyType key = parameters["key"].as<hsrcore::blockchain::PublicKeyType>();
        ...
        fc::variant CommonApiRpcServer::blockchain_get_asset_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            fc::optional<hsrcore::blockchain::AssetEntry> result = get_client()->blockchain_get_asset(asset);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_active_delegates_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::AccountEntry> result = get_client()->blockchain_list_active_delegates(first, count);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_delegates_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::AccountEntry> result = get_client()->blockchain_list_delegates(first, count);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_blocks_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::BlockEntry> result = get_client()->blockchain_list_blocks(max_block_num, limit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_export_fork_graph_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            (fc::json::from_string("-1").as<uint32_t>()) :
            parameters[1].as<uint32_t>();
            hsrcore::blockchain::FilePath filename = (parameters.size() <= 2) ?
            (fc::json::from_string("\"\"").as<hsrcore::blockchain::FilePath>()) :
            parameters[2].as<hsrcore::blockchain::FilePath>();
        ...
        fc::variant CommonApiRpcServer::blockchain_export_fork_graph_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::FilePath filename = parameters.contains("filename") ?
                (fc::json::from_string("\"\"").as<hsrcore::blockchain::FilePath>()) :
                parameters["filename"].as<hsrcore::blockchain::FilePath>();
        ...
        fc::variant CommonApiRpcServer::blockchain_list_forks_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::map<uint32_t, std::vector<hsrcore::blockchain::ForkEntry>> result = get_client()->blockchain_list_forks();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_get_delegate_slot_entrys_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::SlotEntry> result = get_client()->blockchain_get_delegate_slot_entrys(delegate_name, limit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_unclaimed_genesis_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::Asset result = get_client()->blockchain_unclaimed_genesis();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_broadcast_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::SignedTransaction trx = parameters[0].as<hsrcore::blockchain::SignedTransaction>();
        ...
        fc::variant CommonApiRpcServer::blockchain_broadcast_transaction_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::SignedTransaction trx = parameters["trx"].as<hsrcore::blockchain::SignedTransaction>();
        ...
        fc::variant CommonApiRpcServer::blockchain_list_contract_transaction_history_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::wallet::ContractTransactionSummary> result = get_client()->blockchain_list_contract_transaction_history(from_block_num, block_count, contract_id, trx_type, call_method);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::network_broadcast_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::SignedTransaction transaction_to_broadcast = parameters[0].as<hsrcore::blockchain::SignedTransaction>();

            hsrcore::blockchain::TransactionIdType result = get_client()->network_broadcast_transaction(transaction_to_broadcast);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::network_broadcast_transaction_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::SignedTransaction transaction_to_broadcast = parameters["transaction_to_broadcast"].as<hsrcore::blockchain::SignedTransaction>();
        ...
        fc::variant CommonApiRpcServer::network_get_transaction_propagation_data_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::TransactionIdType transaction_id = parameters[0].as<hsrcore::blockchain::TransactionIdType>();

            hsrcore::net::MessagePropagationData result = get_client()->network_get_transaction_propagation_data(transaction_id);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::network_get_transaction_propagation_data_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::TransactionIdType transaction_id = parameters["transaction_id"].as<hsrcore::blockchain::TransactionIdType>();
        ...
        fc::variant CommonApiRpcServer::network_get_block_propagation_data_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::BlockIdType block_hash = parameters[0].as<hsrcore::blockchain::BlockIdType>();

            hsrcore::net::MessagePropagationData result = get_client()->network_get_block_propagation_data(block_hash);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::network_get_block_propagation_data_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::BlockIdType block_hash = parameters["block_hash"].as<hsrcore::blockchain::BlockIdType>();
        ...
        fc::variant CommonApiRpcServer::network_list_potential_peers_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::net::PotentialPeerEntry> result = get_client()->network_list_potential_peers();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::delegate_blacklist_add_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::TransactionIdType id = parameters[0].as<hsrcore::blockchain::TransactionIdType>();
        ...
        fc::variant CommonApiRpcServer::delegate_blacklist_add_transaction_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::TransactionIdType id = parameters["id"].as<hsrcore::blockchain::TransactionIdType>();
        ...
        fc::variant CommonApiRpcServer::delegate_blacklist_add_operation_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            if (parameters.size() <= 0)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 1 (id)");
            hsrcore::blockchain::OperationTypeEnum id = parameters[0].as<hsrcore::blockchain::OperationTypeEnum>();
        ...
        fc::variant CommonApiRpcServer::delegate_blacklist_add_operation_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            if (!parameters.contains("id"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'id'");
            hsrcore::blockchain::OperationTypeEnum id = parameters["id"].as<hsrcore::blockchain::OperationTypeEnum>();
        ...
        fc::variant CommonApiRpcServer::wallet_account_transaction_history_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::wallet::PrettyTransaction> result = get_client()->wallet_account_transaction_history(account_name, asset_symbol, limit, start_block_num, end_block_num);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_transaction_history_splite_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::wallet::PrettyTransaction> result = get_client()->wallet_transaction_history_splite(account_name, asset_symbol, limit, transaction_type);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_account_historic_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::AccountBalanceSummaryType result = get_client()->wallet_account_historic_balance(time, account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_get_pending_transaction_errors_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::FilePath filename = (parameters.size() <= 0) ?
            (fc::json::from_string("\"\"").as<hsrcore::blockchain::FilePath>()) :
            parameters[0].as<hsrcore::blockchain::FilePath>();

            std::map<hsrcore::blockchain::TransactionIdType, fc::exception> result = get_client()->wallet_get_pending_transaction_errors(filename);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_account_create_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::Address result = get_client()->wallet_account_create(account_name, private_data);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_get_all_approved_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::AccountEntry> result = get_client()->wallet_get_all_approved_accounts(approval);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_transfer_to_address_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::VoteStrategy strategy = (parameters.size() <= 5) ?
            (fc::json::from_string("\"vote_recommended\"").as<hsrcore::wallet::VoteStrategy>()) :
            parameters[5].as<hsrcore::wallet::VoteStrategy>();

            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_transfer_to_address(amount_to_transfer, asset_symbol, from_account_name, to_address, memo_message, strategy);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_transfer_to_address_build_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_transfer_to_address_build(amount_to_transfer, asset_symbol, from_account_public_key, to_address, memo_message, strategy);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_transfer_to_public_account_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_transfer_to_public_account(amount_to_transfer, asset_symbol, from_account_name, to_account_name, memo_message, strategy);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_withdraw_from_address_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::Address from_address = parameters[2].as<hsrcore::blockchain::Address>();
            if (parameters.size() <= 3)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 4 (to)");
            std::string to = parameters[3].as<std::string>();
            hsrcore::wallet::VoteStrategy strategy = (parameters.size() <= 4) ?
            (fc::json::from_string("\"vote_none\"").as<hsrcore::wallet::VoteStrategy>()) :
            parameters[4].as<hsrcore::wallet::VoteStrategy>();
            ...
            hsrcore::wallet::TransactionBuilder result = get_client()->wallet_withdraw_from_address(amount, symbol, from_address, to, strategy, sign_and_broadcast, builder_path);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_get_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_get_transaction(transaction_id);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_scan_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_scan_transaction(transaction_id, overwrite_existing);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_account_register_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_account_register(account_name, pay_from_account, public_data, delegate_pay_rate, account_type);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_account_update_registration_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_account_update_registration(account_name, pay_from_account, public_data, delegate_pay_rate);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_account_update_active_key_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_account_update_active_key(account_to_update, pay_from_account, new_active_key);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_list_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::wallet::WalletAccountEntry> result = get_client()->wallet_list_accounts();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_list_unregistered_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::wallet::WalletAccountEntry> result = get_client()->wallet_list_unregistered_accounts();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_list_my_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::wallet::WalletAccountEntry> result = get_client()->wallet_list_my_accounts();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_list_my_addresses_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::wallet::AccountAddressData> result = get_client()->wallet_list_my_addresses();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_get_account_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletAccountEntry result = get_client()->wallet_get_account(account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_asset_create_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_asset_create(symbol, asset_name, issuer_name, description, maximum_share_supply, precision, public_data, is_market_issued);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_asset_issue_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::Imessage memo_message = (parameters.size() <= 3) ?
            (fc::json::from_string("\"\"").as<hsrcore::blockchain::Imessage>()) :
            parameters[3].as<hsrcore::blockchain::Imessage>();

            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_asset_issue(amount, symbol, to_account_name, memo_message);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_asset_issue_to_addresses_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::map<std::string, hsrcore::blockchain::ShareType> addresses = parameters[1].as<std::map<std::string, hsrcore::blockchain::ShareType>>();

            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_asset_issue_to_addresses(symbol, addresses);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_asset_issue_to_addresses_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            std::map<std::string, hsrcore::blockchain::ShareType> addresses = parameters["addresses"].as<std::map<std::string, hsrcore::blockchain::ShareType>>();
        ...
        fc::variant CommonApiRpcServer::wallet_account_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::AccountBalanceSummaryType result = get_client()->wallet_account_balance(account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_account_balance_ids_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::AccountBalanceIdSummaryType result = get_client()->wallet_account_balance_ids(account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_account_list_public_keys_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::wallet::PublicKeySummary> result = get_client()->wallet_account_list_public_keys(account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_delegate_withdraw_pay_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_delegate_withdraw_pay(delegate_name, to_account_name, amount_to_withdraw);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_delegate_pay_balance_query_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::DelegatePaySalary result = get_client()->wallet_delegate_pay_balance_query(delegate_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_active_delegate_salary_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::map<std::string,hsrcore::blockchain::DelegatePaySalary> result = get_client()->wallet_active_delegate_salary();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_set_transaction_fee_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::Asset result = get_client()->wallet_set_transaction_fee(fee);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_get_transaction_fee_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::Asset result = get_client()->wallet_get_transaction_fee(symbol);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_dump_account_private_key_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::AccountKeyType key_type = parameters[1].as<hsrcore::wallet::AccountKeyType>();
        ...
        fc::variant CommonApiRpcServer::wallet_dump_account_private_key_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::wallet::AccountKeyType key_type = parameters["key_type"].as<hsrcore::wallet::AccountKeyType>();
        ...
        fc::variant CommonApiRpcServer::wallet_account_vote_summary_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::AccountVoteSummaryType result = get_client()->wallet_account_vote_summary(account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_check_vote_status_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::VoteSummary result = get_client()->wallet_check_vote_status(account);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_login_finish_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::PublicKeyType server_key = parameters[0].as<hsrcore::blockchain::PublicKeyType>();
            if (parameters.size() <= 1)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 2 (client_key)");
            hsrcore::blockchain::PublicKeyType client_key = parameters[1].as<hsrcore::blockchain::PublicKeyType>();
            if (parameters.size() <= 2)
        ...
        fc::variant CommonApiRpcServer::wallet_login_finish_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::PublicKeyType server_key = parameters["server_key"].as<hsrcore::blockchain::PublicKeyType>();
            if (!parameters.contains("client_key"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'client_key'");
            hsrcore::blockchain::PublicKeyType client_key = parameters["client_key"].as<hsrcore::blockchain::PublicKeyType>();
        ...
        fc::variant CommonApiRpcServer::wallet_balance_set_vote_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            (fc::json::from_string("\"\"").as<std::string>()) :
            parameters[1].as<std::string>();
            hsrcore::wallet::VoteStrategy strategy = (parameters.size() <= 2) ?
            (fc::json::from_string("\"vote_all\"").as<hsrcore::wallet::VoteStrategy>()) :
            parameters[2].as<hsrcore::wallet::VoteStrategy>();
            ...
            hsrcore::wallet::TransactionBuilder result = get_client()->wallet_balance_set_vote_info(balance_id, voter_address, strategy, sign_and_broadcast, builder_path);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_publish_slate_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_publish_slate(publishing_account_name, paying_account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_publish_version_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_publish_version(publishing_account_name, paying_account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_collect_genesis_balances_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_collect_genesis_balances(account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_account_retract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_account_retract(account_to_retract, pay_from_account);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_get_account_owner_publickey_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::PublicKeyType result = get_client()->wallet_get_account_owner_publickey(account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_transfer_to_contract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_transfer_to_contract(amount_to_transfer, asset_symbol, from_account_name, to_contract, amount_for_exec);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sign_build_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry trasaction_building = parameters[0].as<hsrcore::wallet::WalletTransactionEntry>();

            hsrcore::wallet::WalletTransactionEntry result = get_client()->sign_build_transaction(trasaction_building);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sign_build_transaction_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry trasaction_building = parameters["trasaction_building"].as<hsrcore::wallet::WalletTransactionEntry>();
        ...
        fc::variant CommonApiRpcServer::wallet_transfer_to_contract_build_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_transfer_to_contract_build(amount_to_transfer, asset_symbol, from_account_public_key, to_contract, amount_for_exec);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_transfer_to_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::Asset> result = get_client()->wallet_transfer_to_contract_testing(amount_to_transfer, asset_symbol, from_account_name, to_contract);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_import_hshare_private_key_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (parameters.size() <= 0)
			    FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 1 (acc_name)");
        ...
        fc::variant CommonApiRpcServer::wallet_import_hshare_private_key_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (!parameters.contains("acc_name"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'acc_name'");
        ...
        fc::variant CommonApiRpcServer::wallet_import_hshare_encrypted_private_key_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (parameters.size() <= 0)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 1 (passwd)");
            std::string passwd = parameters[0].as<std::string>();
            if (parameters.size() <= 1)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 2 (acc_name)");
        ...
        fc::variant CommonApiRpcServer::wallet_import_hshare_encrypted_private_key_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (!parameters.contains("passwd"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'passwd'");
            std::string passwd = parameters["passwd"].as<std::string>();
            if (!parameters.contains("acc_name"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'acc_name'");
            std::string acc_name = parameters["acc_name"].as<std::string>();
            if (!parameters.contains("infile"))
        ...
        fc::variant CommonApiRpcServer::wallet_multisig_deposit_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->wallet_multisig_deposit(amount, asset_symbol, from_account, m, addresses, memo_message);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_multisig_get_address_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            hsrcore::blockchain::Address result = get_client()->wallet_multisig_get_address(asset_symbol, m, addresses);
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::wallet_multisig_get_address_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
        ...
        fc::variant CommonApiRpcServer::builder_finalize_and_sign_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->builder_finalize_and_sign(builder);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::meta_help_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::map<std::string, hsrcore::api::MethodData> result = get_client()->meta_help();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::register_contract_build_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (parameters.size() <= 0)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 1 (owner_public_key)");
            std::string owner_public_key = parameters[0].as<std::string>();
            if (parameters.size() <= 1)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 2 (codefile)");
            fc::path codefile = parameters[1].as<fc::path>();
            if (parameters.size() <= 2)
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->register_contract_build(owner_public_key, codefile, asset_symbol, init_limit);
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::register_contract_build_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (!parameters.contains("owner_public_key"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'owner_public_key'");
            std::string owner_public_key = parameters["owner_public_key"].as<std::string>();
            if (!parameters.contains("codefile"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'codefile'");
            fc::path codefile = parameters["codefile"].as<fc::path>();
            if (!parameters.contains("asset_symbol"))
        ...
        fc::variant CommonApiRpcServer::register_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::Asset> result = get_client()->register_contract_testing(owner, codefile);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::upgrade_contract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::Imessage new_contract_desc = parameters[3].as<hsrcore::blockchain::Imessage>();
            if (parameters.size() <= 4)
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->upgrade_contract(contract_address, upgrader_name, new_contract_name, new_contract_desc, asset_symbol, exec_limit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::upgrade_contract_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::Imessage new_contract_desc = parameters["new_contract_desc"].as<hsrcore::blockchain::Imessage>();
            if (!parameters.contains("asset_symbol"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'asset_symbol'");
            std::string asset_symbol = parameters["asset_symbol"].as<std::string>();
        ...
        fc::variant CommonApiRpcServer::upgrade_contract_build_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            std::string contract_address = parameters[0].as<std::string>();
            if (parameters.size() <= 1)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 2 (upgrader_public_key)");
            std::string upgrader_public_key = parameters[1].as<std::string>();
            if (parameters.size() <= 2)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 3 (new_contract_name)");
            std::string new_contract_name = parameters[2].as<std::string>();
            if (parameters.size() <= 3)
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->upgrade_contract_build(contract_address, upgrader_public_key, new_contract_name, new_contract_desc, asset_symbol, exec_limit);
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::upgrade_contract_build_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (!parameters.contains("contract_address"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'contract_address'");
            std::string contract_address = parameters["contract_address"].as<std::string>();
            if (!parameters.contains("upgrader_public_key"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'upgrader_public_key'");
            std::string upgrader_public_key = parameters["upgrader_public_key"].as<std::string>();
            if (!parameters.contains("new_contract_name"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'new_contract_name'");
            std::string new_contract_name = parameters["new_contract_name"].as<std::string>();
            if (!parameters.contains("new_contract_desc"))
        ...
        fc::variant CommonApiRpcServer::upgrade_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::Asset> result = get_client()->upgrade_contract_testing(contract_address, upgrader_name, new_contract_name, new_contract_desc);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::destroy_contract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->destroy_contract(contract_address, destroyer_name, asset_symbol, exec_limit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::destroy_contract_build_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            std::string contract_address = parameters[0].as<std::string>();
            if (parameters.size() <= 1)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 2 (destroyer_public_key)");
            std::string destroyer_public_key = parameters[1].as<std::string>();
            if (parameters.size() <= 2)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 3 (asset_symbol)");
            std::string asset_symbol = parameters[2].as<std::string>();
            if (parameters.size() <= 3)
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->destroy_contract_build(contract_address, destroyer_public_key, asset_symbol, exec_limit);
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::destroy_contract_build_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (!parameters.contains("contract_address"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'contract_address'");
            std::string contract_address = parameters["contract_address"].as<std::string>();
            if (!parameters.contains("destroyer_public_key"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'destroyer_public_key'");
            std::string destroyer_public_key = parameters["destroyer_public_key"].as<std::string>();
            if (!parameters.contains("asset_symbol"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'asset_symbol'");
            std::string asset_symbol = parameters["asset_symbol"].as<std::string>();
            if (!parameters.contains("exec_limit"))
        ...
        fc::variant CommonApiRpcServer::destroy_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::Asset> result = get_client()->destroy_contract_testing(contract_address, destroyer_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::call_contract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->call_contract(contract, caller_name, function_name, params, asset_symbol, call_limit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::call_contract_build_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            std::string contract = parameters[0].as<std::string>();
            if (parameters.size() <= 1)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 2 (caller_public_key)");
            std::string caller_public_key = parameters[1].as<std::string>();
            if (parameters.size() <= 2)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 3 (function_name)");
            std::string function_name = parameters[2].as<std::string>();
            if (parameters.size() <= 3)
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->call_contract_build(contract, caller_public_key, function_name, params, asset_symbol, call_limit);
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::call_contract_build_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (!parameters.contains("contract"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'contract'");
            std::string contract = parameters["contract"].as<std::string>();
            if (!parameters.contains("caller_public_key"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'caller_public_key'");
            std::string caller_public_key = parameters["caller_public_key"].as<std::string>();
            if (!parameters.contains("function_name"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'function_name'");
            std::string function_name = parameters["function_name"].as<std::string>();
            if (!parameters.contains("params"))
        ...
        fc::variant CommonApiRpcServer::get_contract_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::ContractEntryPrintable result = get_client()->get_contract_info(contract);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::get_contract_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::BalanceEntry> result = get_client()->get_contract_balance(contract);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::call_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::Asset> result = get_client()->call_contract_testing(contract, caller_name, function_name, params);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::load_contract_to_file_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::ContractEntryPrintable result = get_client()->load_contract_to_file(contract, file);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::get_result_trx_id_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::TransactionIdType request_id = parameters[0].as<hsrcore::blockchain::TransactionIdType>();

            hsrcore::blockchain::TransactionIdType result = get_client()->get_result_trx_id(request_id);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::get_result_trx_id_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::TransactionIdType request_id = parameters["request_id"].as<hsrcore::blockchain::TransactionIdType>();
        ...
        fc::variant CommonApiRpcServer::get_request_trx_id_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::TransactionIdType result = get_client()->get_request_trx_id(request_id);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_call_contract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->sandbox_call_contract(contract, caller_name, function_name, params, cost_asset, callLimit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_upgrade_contract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->sandbox_upgrade_contract(contract_address, upgrader_name, new_contract_name, new_contract_desc, asset_symbol, exec_limit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_upgrade_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::Asset> result = get_client()->sandbox_upgrade_contract_testing(contract_address, upgrader_name, new_contract_name, new_contract_desc);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_destroy_contract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->sandbox_destroy_contract(contract_address, destroyer_name, asset_symbol, exec_limit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_destroy_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::Asset> result = get_client()->sandbox_destroy_contract_testing(contract_address, destroyer_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_get_contract_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::ContractEntryPrintable result = get_client()->sandbox_get_contract_info(contract);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_get_contract_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::BalanceEntry> result = get_client()->sandbox_get_contract_balance(contract);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_transfer_to_contract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::WalletTransactionEntry result = get_client()->sandbox_transfer_to_contract(amount_to_transfer, asset_symbol, from_account_name, to_contract, amount_for_exec);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_account_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::AccountBalanceSummaryType result = get_client()->sandbox_account_balance(account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_load_contract_to_file_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::ContractEntryPrintable result = get_client()->sandbox_load_contract_to_file(contract, file);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_register_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::Asset> result = get_client()->sandbox_register_contract_testing(owner, codefile);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_call_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::Asset> result = get_client()->sandbox_call_contract_testing(contract, caller_name, function_name, params);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_transfer_to_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::blockchain::Asset> result = get_client()->sandbox_transfer_to_contract_testing(amount_to_transfer, asset_symbol, from_account_name, to_contract);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sandbox_list_my_addresses_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            vector<hsrcore::blockchain::SandboxAccountInfo> result = get_client()->sandbox_list_my_addresses(account_name);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::get_contract_registered_in_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::TransactionIdType trx_id = parameters[0].as<hsrcore::blockchain::TransactionIdType>();
        ...
        fc::variant CommonApiRpcServer::get_contract_registered_in_transaction_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            hsrcore::blockchain::TransactionIdType trx_id = parameters["trx_id"].as<hsrcore::blockchain::TransactionIdType>();
        ...
        fc::variant CommonApiRpcServer::get_transaction_id_contract_registered_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::TransactionIdType result = get_client()->get_transaction_id_contract_registered(contract_id);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::get_contract_info_from_gpc_file_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::CodePrintAble result = get_client()->get_contract_info_from_gpc_file(file);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::get_mining_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // this method has no prerequisites


            MiningInfo result = get_client()->get_mining_info();
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::get_mining_info_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // this method has no prerequisites
        ...
        fc::variant CommonApiRpcServer::get_difficulty_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // this method has no prerequisites


            MiningDifficulty result = get_client()->get_difficulty();
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::get_difficulty_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // this method has no prerequisites
        ...
        fc::variant CommonApiRpcServer::set_generate_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (parameters.size() <= 0)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 1 (fGenerate)");
            bool fGenerate = parameters[0].as<bool>();
            uint32_t nThreads = (parameters.size() <= 1) ?
            (fc::json::from_string("-1").as<uint32_t>()) :
            parameters[1].as<uint32_t>();

            bool result = get_client()->set_generate(fGenerate, nThreads);
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::set_generate_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (!parameters.contains("fGenerate"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'fGenerate'");
            bool fGenerate = parameters["fGenerate"].as<bool>();
            uint32_t nThreads = parameters.contains("nThreads") ?
                (fc::json::from_string("-1").as<uint32_t>()) :
                parameters["nThreads"].as<uint32_t>();

            bool result = get_client()->set_generate(fGenerate, nThreads);
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::get_work_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            MiningWorkPackage result = get_client()->get_work();
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::get_work_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
        ...
        fc::variant CommonApiRpcServer::submit_block_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (parameters.size() <= 0)
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 1 (HashNoNonce)");
            std::string HashNoNonce = parameters[0].as<std::string>();
            if (parameters.size() <= 1)
        ...
        fc::variant CommonApiRpcServer::submit_block_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            if (!parameters.contains("HashNoNonce"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'HashNoNonce'");
            std::string HashNoNonce = parameters["HashNoNonce"].as<std::string>();
        ...
        fc::variant CommonApiRpcServer::set_coinbase_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            bool result = get_client()->set_coinbase(account_name);
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::set_coinbase_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
        ...
        fc::variant CommonApiRpcServer::get_staking_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
            ...
            StakingInfo result = get_client()->get_staking_info();
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::get_staking_info_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // check all of this method's prerequisites
            verify_json_connection_is_authenticated(json_connection);
            verify_wallet_is_open();
        ...
        fc::variant CommonApiRpcServer::add_script_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::blockchain::Imessage description = parameters[1].as<hsrcore::blockchain::Imessage>();
        ...
        fc::variant CommonApiRpcServer::add_script_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            if (!parameters.contains("description"))
                FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'description'");
            hsrcore::blockchain::Imessage description = parameters["description"].as<hsrcore::blockchain::Imessage>();
        ...
        fc::variant CommonApiRpcServer::get_script_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            hsrcore::wallet::ScriptEntryPrintable result = get_client()->get_script_info(scriptid);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::list_scripts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::vector<hsrcore::wallet::ScriptEntryPrintable> result = get_client()->list_scripts();
            return fc::variant(result);
        }
        ...
        void CommonApiRpcServer::register_common_api_methods(const fc::rpc::json_connection_ptr& json_connection)
        {
           ...
           // register method blockchain_get_hsr_account_balance_entry
            bound_positional_method = boost::bind(&CommonApiRpcServer::blockchain_get_hsr_account_balance_entry_positional,
                this, capture_con, _1);
            json_connection->add_method("blockchain_get_hsr_account_balance_entry", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::blockchain_get_hsr_account_balance_entry_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("blockchain_get_hsr_account_balance_entry", bound_named_method);
           ...
           // register method wallet_import_hshare_private_key
            bound_positional_method = boost::bind(&CommonApiRpcServer::wallet_import_hshare_private_key_positional,
                this, capture_con, _1);
            json_connection->add_method("wallet_import_hshare_private_key", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::wallet_import_hshare_private_key_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("wallet_import_hshare_private_key", bound_named_method);

            // register method wallet_import_hshare_encrypted_private_key
            bound_positional_method = boost::bind(&CommonApiRpcServer::wallet_import_hshare_encrypted_private_key_positional, 
                                        this, capture_con, _1);
            json_connection->add_method("wallet_import_hshare_encrypted_private_key", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::wallet_import_hshare_encrypted_private_key_named, 
                                        this, capture_con, _1);
           ...
           // register method wallet_multisig_get_address
            bound_positional_method = boost::bind(&CommonApiRpcServer::wallet_multisig_get_address_positional,
                this, capture_con, _1);
            json_connection->add_method("wallet_multisig_get_address", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::wallet_multisig_get_address_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("wallet_multisig_get_address", bound_named_method);
           ...
           // register method register_contract_build
            bound_positional_method = boost::bind(&CommonApiRpcServer::register_contract_build_positional,
                this, capture_con, _1);
            json_connection->add_method("register_contract_build", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::register_contract_build_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("register_contract_build", bound_named_method);
           ...
           // register method upgrade_contract_build
            bound_positional_method = boost::bind(&CommonApiRpcServer::upgrade_contract_build_positional,
                this, capture_con, _1);
            json_connection->add_method("upgrade_contract_build", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::upgrade_contract_build_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("upgrade_contract_build", bound_named_method);
           ...
           // register method destroy_contract_build
            bound_positional_method = boost::bind(&CommonApiRpcServer::destroy_contract_build_positional,
                this, capture_con, _1);
            json_connection->add_method("destroy_contract_build", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::destroy_contract_build_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("destroy_contract_build", bound_named_method);
           ...
           // register method call_contract_build
            bound_positional_method = boost::bind(&CommonApiRpcServer::call_contract_build_positional,
                this, capture_con, _1);
            json_connection->add_method("call_contract_build", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::call_contract_build_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("call_contract_build", bound_named_method);
           ...
           // register method get_mining_info
            bound_positional_method = boost::bind(&CommonApiRpcServer::get_mining_info_positional,
                this, capture_con, _1);
            json_connection->add_method("get_mining_info", bound_positional_method);
            json_connection->add_method("mininginfo", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::get_mining_info_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("get_mining_info", bound_named_method);
            json_connection->add_named_param_method("mininginfo", bound_named_method);

           // register method get_difficulty
            bound_positional_method = boost::bind(&CommonApiRpcServer::get_difficulty_positional,
                this, capture_con, _1);
            json_connection->add_method("get_difficulty", bound_positional_method);
            json_connection->add_method("difficulty", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::get_difficulty_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("get_difficulty", bound_named_method);
            json_connection->add_named_param_method("difficulty", bound_named_method);

           // register method set_generate
            bound_positional_method = boost::bind(&CommonApiRpcServer::set_generate_positional,
                this, capture_con, _1);
            json_connection->add_method("set_generate", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::set_generate_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("set_generate", bound_named_method);

           // register method get_work
            bound_positional_method = boost::bind(&CommonApiRpcServer::get_work_positional,
                this, capture_con, _1);
            json_connection->add_method("get_work", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::get_work_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("get_work", bound_named_method);

           // register method submit_block
            bound_positional_method = boost::bind(&CommonApiRpcServer::submit_block_positional,
                this, capture_con, _1);
            json_connection->add_method("submit_block", bound_positional_method);
           ...
           // register method set_coinbase
            bound_positional_method = boost::bind(&CommonApiRpcServer::set_coinbase_positional,
                this, capture_con, _1);
            json_connection->add_method("set_coinbase", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::set_coinbase_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("set_coinbase", bound_named_method);

           // register method get_staking_info
            bound_positional_method = boost::bind(&CommonApiRpcServer::get_staking_info_positional,
                this, capture_con, _1);
            json_connection->add_method("get_staking_info", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::get_staking_info_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("get_staking_info", bound_named_method);
        ...
        void CommonApiRpcServer::register_common_api_method_metadata()
        {
            {
                // register method blockchain_get_info
                hsrcore::api::MethodData blockchain_get_info_method_metadata{ "blockchain_get_info", nullptr,
                    /* description */ "Returns current blockchain information and parameters",
                    /* returns */ "json_object",
                    /* params: */{                    },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_generate_snapshot
                hsrcore::api::MethodData blockchain_generate_snapshot_method_metadata{ "blockchain_generate_snapshot", nullptr,
                    /* description */ "Save snapshot of current base asset balances to specified file",
                    /* returns */ "void",
                    /* params: */{
                        {"filename", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_hsr_account_balance_entry
                hsrcore::api::MethodData blockchain_get_hsr_account_balance_entry_method_metadata{ "blockchain_get_hsr_account_balance_entry", nullptr,
                    /* description */ "fetch all HSRTrxidBalance from block where blocknum of the block lower than block_num or equal to block_num.",
                    /* returns */ "vector<hsr_trxid_balance>",
                    /* params: */{
                        {"block_num", "uint32_t", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
                    /* detailed description */ "fetch all HSRTrxidBalance from block where blocknum of the block lower than block_num or equal to block_num.\n\nParameters:\n  block_num (uint32_t, required): \n\nReturns:\n  vector<hsr_trxid_balance>\n",
                    /* aliases */ {}, false};
                store_method_metadata(blockchain_get_hsr_account_balance_entry_method_metadata);
            }

            {
                // register method blockchain_generate_issuance_map
                hsrcore::api::MethodData blockchain_generate_issuance_map_method_metadata{ "blockchain_generate_issuance_map", nullptr,
                    /* description */ "A utility to help verify UIA distribution. Returns a snapshot map of all issuances for a particular UIA.",
                    /* returns */ "void",
                    /* params: */{
                        {"symbol", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"filename", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_calculate_supply
                hsrcore::api::MethodData blockchain_calculate_supply_method_metadata{ "blockchain_calculate_supply", nullptr,
                    /* description */ "Calculate the total supply of an asset from the current blockchain database state",
                    /* returns */ "asset",
                    /* params: */{
                        {"asset", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_is_synced
                hsrcore::api::MethodData blockchain_is_synced_method_metadata{ "blockchain_is_synced", nullptr,
            ...
            {
                // register method blockchain_get_block_count
                hsrcore::api::MethodData blockchain_get_block_count_method_metadata{ "blockchain_get_block_count", nullptr,
            ...
            {
                // register method blockchain_get_security_state
                hsrcore::api::MethodData blockchain_get_security_state_method_metadata{ "blockchain_get_security_state", nullptr,
            ...
            {
                // register method blockchain_list_accounts
                hsrcore::api::MethodData blockchain_list_accounts_method_metadata{ "blockchain_list_accounts", nullptr,
                    /* description */ "Returns registered accounts starting with a given name upto a the limit provided",
                    /* returns */ "account_entry_array",
                    /* params: */{
                        {"first_account_name", "account_name", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"limit", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("20"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_recently_updated_accounts
                hsrcore::api::MethodData blockchain_list_recently_updated_accounts_method_metadata{ "blockchain_list_recently_updated_accounts", nullptr,
            ...
            {
                // register method blockchain_list_recently_registered_accounts
                hsrcore::api::MethodData blockchain_list_recently_registered_accounts_method_metadata{ "blockchain_list_recently_registered_accounts", nullptr,
            ...
            {
                // register method blockchain_list_assets
                hsrcore::api::MethodData blockchain_list_assets_method_metadata{ "blockchain_list_assets", nullptr,
                    /* description */ "Returns registered assets starting with a given name upto a the limit provided",
                    /* returns */ "asset_entry_array",
                    /* params: */{
                        {"first_symbol", "asset_symbol", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"limit", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("20"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_pending_transactions
                hsrcore::api::MethodData blockchain_list_pending_transactions_method_metadata{ "blockchain_list_pending_transactions", nullptr,
            ...
            {
                // register method blockchain_get_transaction
                hsrcore::api::MethodData blockchain_get_transaction_method_metadata{ "blockchain_get_transaction", nullptr,
                    /* description */ "Get detailed information about an in-wallet transaction",
                    /* returns */ "transaction_entry_pair",
                    /* params: */{
                        {"transaction_id_prefix", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"exact", "bool", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_pretty_transaction
                hsrcore::api::MethodData blockchain_get_pretty_transaction_method_metadata{ "blockchain_get_pretty_transaction", nullptr,
            ...
            {
                // register method blockchain_get_pretty_contract_transaction
                hsrcore::api::MethodData blockchain_get_pretty_contract_transaction_method_metadata{ "blockchain_get_pretty_contract_transaction", nullptr,
            ...
            {
                // register method blockchain_get_block
                hsrcore::api::MethodData blockchain_get_block_method_metadata{ "blockchain_get_block", nullptr,
                    /* description */ "Retrieves the block entry for the given block number or ID",
                    /* returns */ "oblock_entry",
                    /* params: */{
                        {"block", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_block_transactions
                hsrcore::api::MethodData blockchain_get_block_transactions_method_metadata{ "blockchain_get_block_transactions", nullptr,
            ...
            {
                // register method blockchain_get_account
                hsrcore::api::MethodData blockchain_get_account_method_metadata{ "blockchain_get_account", nullptr,
                    /* description */ "Retrieves the entry for the given account name or ID",
                    /* returns */ "optional_account_entry",
                    /* params: */{
                        {"account", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_slate
                hsrcore::api::MethodData blockchain_get_slate_method_metadata{ "blockchain_get_slate", nullptr,
                    ...
                    /* params: */{
                        {"slate", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_balance
                hsrcore::api::MethodData blockchain_get_balance_method_metadata{ "blockchain_get_balance", nullptr,
                    /* description */ "Retrieves the specified balance entry",
                    /* returns */ "balance_entry",
                    /* params: */{
                        {"balance_id", "address", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_balances
                hsrcore::api::MethodData blockchain_list_balances_method_metadata{ "blockchain_list_balances", nullptr,
                    /* description */ "Lists balance entrys starting at the given balance ID",
                    /* returns */ "balance_entry_map",
                    /* params: */{
                        {"first_balance_id", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"limit", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("20"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_address_balances
                hsrcore::api::MethodData blockchain_list_address_balances_method_metadata{ "blockchain_list_address_balances", nullptr,
                    /* description */ "Lists balance entrys which are the balance IDs or which can be claimed by signature for this address",
                    /* returns */ "balance_entry_map",
                    /* params: */{
                        {"addr", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"chanced_since", "timestamp", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"1970-1-1T00:00:01\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_address_transactions
                hsrcore::api::MethodData blockchain_list_address_transactions_method_metadata{ "blockchain_list_address_transactions", nullptr,
                    /* description */ "Lists all transactions that involve the provided address after the specified time",
                    /* returns */ "variant_object",
                    /* params: */{
                        {"addr", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"filter_before", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"0\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_account_public_balance
                hsrcore::api::MethodData blockchain_get_account_public_balance_method_metadata{ "blockchain_get_account_public_balance", nullptr,
                    /* description */ "Get the account entry for a given name",
                    /* returns */ "account_balance_summary_type",
                    /* params: */{
                        {"account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()}
                          },
            ...
            {
                // register method blockchain_list_key_balances
                hsrcore::api::MethodData blockchain_list_key_balances_method_metadata{ "blockchain_list_key_balances", nullptr,
                    /* description */ "Lists balance entrys which can be claimed by signature for this key",
                    /* returns */ "balance_entry_map",
                    /* params: */{
                        {"key", "public_key", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_asset
                hsrcore::api::MethodData blockchain_get_asset_method_metadata{ "blockchain_get_asset", nullptr,
            ...
            {
                // register method blockchain_list_active_delegates
                hsrcore::api::MethodData blockchain_list_active_delegates_method_metadata{ "blockchain_list_active_delegates", nullptr,
                    /* description */ "Returns a list of the current round's active delegates in signing order",
                    /* returns */ "account_entry_array",
                    /* params: */{
                        {"first", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("0"))},
                        {"count", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("20"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_delegates
                hsrcore::api::MethodData blockchain_list_delegates_method_metadata{ "blockchain_list_delegates", nullptr,
            ...
            {
                // register method blockchain_list_blocks
                hsrcore::api::MethodData blockchain_list_blocks_method_metadata{ "blockchain_list_blocks", nullptr,
                    /* description */ "Returns a descending list of block entrys starting from the specified block number",
                    /* returns */ "block_entry_array",
                    /* params: */{
                        {"max_block_num", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))},
                        {"limit", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("20"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_missing_block_delegates
                hsrcore::api::MethodData blockchain_list_missing_block_delegates_method_metadata{ "blockchain_list_missing_block_delegates", nullptr,
                    /* description */ "Returns any delegates who were supposed to produce a given block number but didn't",
                    /* returns */ "account_name_array",
                    /* params: */{
                        {"block_number", "uint32_t", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_export_fork_graph
                hsrcore::api::MethodData blockchain_export_fork_graph_method_metadata{ "blockchain_export_fork_graph", nullptr,
                    /* description */ "dumps the fork data to graphviz format",
                    /* returns */ "string",
                    /* params: */{
                        {"start_block", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("1"))},
                        {"end_block", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))},
                        {"filename", "path", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_forks
                hsrcore::api::MethodData blockchain_list_forks_method_metadata{ "blockchain_list_forks", nullptr,
            ...
            {
                // register method blockchain_get_delegate_slot_entrys
                hsrcore::api::MethodData blockchain_get_delegate_slot_entrys_method_metadata{ "blockchain_get_delegate_slot_entrys", nullptr,
                    /* description */ "Query the most recent block production slot entrys for the specified delegate",
                    /* returns */ "slot_entrys_list",
                    /* params: */{
                        {"delegate_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"limit", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"10\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_block_signee
                hsrcore::api::MethodData blockchain_get_block_signee_method_metadata{ "blockchain_get_block_signee", nullptr,
            ...
            {
                // register method blockchain_unclaimed_genesis
                hsrcore::api::MethodData blockchain_unclaimed_genesis_method_metadata{ "blockchain_unclaimed_genesis", nullptr,
            ...
            {
                // register method blockchain_verify_signature
                hsrcore::api::MethodData blockchain_verify_signature_method_metadata{ "blockchain_verify_signature", nullptr,
                    /* description */ "Verify that the given signature proves the given hash was signed by the given account.",
                    /* returns */ "bool",
                    /* params: */{
                        {"signer", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"hash", "sha256", hsrcore::api::required_positional, fc::ovariant()},
                        {"signature", "compact_signature", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_dump_state
                hsrcore::api::MethodData blockchain_dump_state_method_metadata{ "blockchain_dump_state", nullptr,
                    /* description */ "TODO",
                    /* returns */ "void",
                    /* params: */{
                        {"path", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_broadcast_transaction
                hsrcore::api::MethodData blockchain_broadcast_transaction_method_metadata{ "blockchain_broadcast_transaction", nullptr,
                    /* description */ "Takes a signed transaction and broadcasts it to the network.",
                    /* returns */ "void",
                    /* params: */{
                        {"trx", "signed_transaction", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_btc_address_convert
                hsrcore::api::MethodData blockchain_btc_address_convert_method_metadata{ "blockchain_btc_address_convert", nullptr,
                    /* description */ "Convert bitcoin address file to hsrcore address file.",
                    /* returns */ "void",
                    /* params: */{
                        {"path", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
                    /* detailed description */ "Convert bitcoin address file to hsrcore address file.\n\nParameters:\n  path (string, required): The bitcoin address file path.\n\nReturns:\n  void\n",
                    /* aliases */ {}, true};
            ...
            {
                // register method blockchain_get_transaction_rpc
                hsrcore::api::MethodData blockchain_get_transaction_rpc_method_metadata{ "blockchain_get_transaction_rpc", nullptr,
                    /* description */ "Get detailed information about an in-wallet transaction",
                    /* returns */ "string",
                    /* params: */{
                        {"transaction_id_prefix", "string", hsrcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method blockchain_set_node_vm_enabled
                hsrcore::api::MethodData blockchain_set_node_vm_enabled_method_metadata{ "blockchain_set_node_vm_enabled", nullptr,
                    /* description */ "set the vm enabled flag of normal node, no effect for the delegate",
                    /* returns */ "void",
                    /* params: */{
                        {"enabled", "bool", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_node_vm_enabled
                hsrcore::api::MethodData blockchain_get_node_vm_enabled_method_metadata{ "blockchain_get_node_vm_enabled", nullptr,
            ...
            {
                // register method blockchain_get_all_contracts
                hsrcore::api::MethodData blockchain_get_all_contracts_method_metadata{ "blockchain_get_all_contracts", nullptr,
            ...
            {
                // register method blockchain_get_forever_contracts
                hsrcore::api::MethodData blockchain_get_forever_contracts_method_metadata{ "blockchain_get_forever_contracts", nullptr,
            ...
            {
                // register method blockchain_list_pub_all_address
                hsrcore::api::MethodData blockchain_list_pub_all_address_method_metadata{ "blockchain_list_pub_all_address", nullptr,
                    /* description */ "list all address converted by public",
                    /* returns */ "string_array",
                    /* params: */{
                        {"pub_key", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
...

            {
				...
				hsrcore::api::MethodData blockchain_list_contract_transaction_history_method_metadata{ "blockchain_list_contract_transaction_history", nullptr,
                    /* description */ "Lists contract transactions match the conditions",
                    /* returns */ "contract_transaction_summarys",
                    /* params: */{
                        {"from_block_num", "uint32_t", hsrcore::api::required_positional, fc::ovariant()},
                        {"block_count", "uint32_t", hsrcore::api::required_positional, fc::ovariant()},
                        {"contract_id", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"trx_type", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"99\""))},
                        {"call_method", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
                    /* detailed description */ "Lists contract transactions match the conditions\n\nParameters:\n  from_block_num (uint32_t, required): start block num\n  block_count (uint32_t, required): block count\n  contract_id (string, optional, defaults to \"\"): contract_id of contract transaction, and Null string represents all contract id\n  trx_type (uint32_t, optional, defaults to \"99\"): contract transaction type, 99 represents all kinds of transaction type\n  call_method (string, optional, defaults to \"\"): if contract transaction type is set to call_contract_transaction, this arg can work, and it represents the method called\n\nReturns:\n  contract_transaction_summarys\n",
                    /* aliases */ {""}, true};
            ...
            {
                // register method network_add_node
                hsrcore::api::MethodData network_add_node_method_metadata{ "network_add_node", nullptr,
                    /* description */ "Attempts add or remove <node> from the peer list or try a connection to <node> once",
                    /* returns */ "void",
                    /* params: */{
                        {"node", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"command", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"add\""))}
                          },
            ...
            {
                // register method network_get_connection_count
                hsrcore::api::MethodData network_get_connection_count_method_metadata{ "network_get_connection_count", nullptr,
            ...
            {
                // register method network_get_peer_info
                hsrcore::api::MethodData network_get_peer_info_method_metadata{ "network_get_peer_info", nullptr,
                    /* description */ "Returns data about each connected node",
                    /* returns */ "json_object_array",
                    /* params: */{
                        {"not_firewalled", "bool", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method network_broadcast_transaction
                hsrcore::api::MethodData network_broadcast_transaction_method_metadata{ "network_broadcast_transaction", nullptr,
                    /* description */ "Broadcast a previously-created signed transaction to the network",
                    /* returns */ "transaction_id",
                    /* params: */{
                        {"transaction_to_broadcast", "signed_transaction", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 9,
            ...
            {
                // register method network_set_advanced_node_parameters
                hsrcore::api::MethodData network_set_advanced_node_parameters_method_metadata{ "network_set_advanced_node_parameters", nullptr,
                    /* description */ "Sets advanced node parameters, used for setting up automated tests",
                    /* returns */ "void",
                    /* params: */{
                        {"params", "json_object", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method network_get_advanced_node_parameters
                hsrcore::api::MethodData network_get_advanced_node_parameters_method_metadata{ "network_get_advanced_node_parameters", nullptr,
                    /* description */ "Sets advanced node parameters, used for setting up automated tests",
                    /* returns */ "json_object",
                    /* params: */{                    },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method network_get_transaction_propagation_data
                hsrcore::api::MethodData network_get_transaction_propagation_data_method_metadata{ "network_get_transaction_propagation_data", nullptr,
                    /* description */ "Returns the time the transaction was first seen by this client",
                    /* returns */ "message_propagation_data",
                    /* params: */{
                        {"transaction_id", "transaction_id", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method network_get_block_propagation_data
                hsrcore::api::MethodData network_get_block_propagation_data_method_metadata{ "network_get_block_propagation_data", nullptr,
                    /* description */ "Returns the time the block was first seen by this client",
                    /* returns */ "message_propagation_data",
                    /* params: */{
                        {"block_hash", "block_id_type", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method network_get_info
                hsrcore::api::MethodData network_get_info_method_metadata{ "network_get_info", nullptr,
            ...
            {
                // register method network_list_potential_peers
                hsrcore::api::MethodData network_list_potential_peers_method_metadata{ "network_list_potential_peers", nullptr,
            ...
            {
                // register method network_get_upnp_info
                hsrcore::api::MethodData network_get_upnp_info_method_metadata{ "network_get_upnp_info", nullptr,
            ...
            {
                // register method network_get_blocked_ips
                hsrcore::api::MethodData network_get_blocked_ips_method_metadata{ "network_get_blocked_ips", nullptr,
            ...
            {
                // register method debug_get_client_name
                hsrcore::api::MethodData debug_get_client_name_method_metadata{ "debug_get_client_name", nullptr,
            ...
            {
                // register method delegate_get_config
                hsrcore::api::MethodData delegate_get_config_method_metadata{ "delegate_get_config", nullptr,
            ...
            {
                // register method delegate_set_network_min_connection_count
                hsrcore::api::MethodData delegate_set_network_min_connection_count_method_metadata{ "delegate_set_network_min_connection_count", nullptr,
                    /* description */ "Set minimum network connection count required for block production",
                    /* returns */ "void",
                    /* params: */{
                        {"count", "uint32_t", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_set_block_max_transaction_count
                hsrcore::api::MethodData delegate_set_block_max_transaction_count_method_metadata{ "delegate_set_block_max_transaction_count", nullptr,
            ...
            {
                // register method delegate_set_soft_max_imessage_length
                hsrcore::api::MethodData delegate_set_soft_max_imessage_length_method_metadata{ "delegate_set_soft_max_imessage_length", nullptr,
                    /* description */ "Set soft max length",
                    /* returns */ "void",
                    /* params: */{
                        {"soft_length", "int64_t", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_set_imessage_fee_coe
                hsrcore::api::MethodData delegate_set_imessage_fee_coe_method_metadata{ "delegate_set_imessage_fee_coe", nullptr,
                    /* description */ "Set fee coe",
                    /* returns */ "void",
                    /* params: */{
                        {"fee_coe", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_set_block_max_size
                hsrcore::api::MethodData delegate_set_block_max_size_method_metadata{ "delegate_set_block_max_size", nullptr,
                    /* description */ "Set maximum block size allowed",
                    /* returns */ "void",
                    /* params: */{
                        {"size", "uint32_t", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_set_transaction_max_size
                hsrcore::api::MethodData delegate_set_transaction_max_size_method_metadata{ "delegate_set_transaction_max_size", nullptr,
            ...
            {
                // register method delegate_set_transaction_canonical_signatures_required
                hsrcore::api::MethodData delegate_set_transaction_canonical_signatures_required_method_metadata{ "delegate_set_transaction_canonical_signatures_required", nullptr,
                    /* description */ "Set whether canonical signatures are required",
                    /* returns */ "void",
                    /* params: */{
                        {"required", "bool", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_set_transaction_min_fee
                hsrcore::api::MethodData delegate_set_transaction_min_fee_method_metadata{ "delegate_set_transaction_min_fee", nullptr,
                    /* description */ "Set minimum transaction fee allowed",
                    /* returns */ "void",
                    /* params: */{
                        {"fee", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_blacklist_add_transaction
                hsrcore::api::MethodData delegate_blacklist_add_transaction_method_metadata{ "delegate_blacklist_add_transaction", nullptr,
                    /* description */ "Add specified transaction to blacklist",
                    /* returns */ "void",
                    /* params: */{
                        {"id", "transaction_id", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_blacklist_remove_transaction
                hsrcore::api::MethodData delegate_blacklist_remove_transaction_method_metadata{ "delegate_blacklist_remove_transaction", nullptr,
            ...
            {
                // register method delegate_blacklist_add_operation
                hsrcore::api::MethodData delegate_blacklist_add_operation_method_metadata{ "delegate_blacklist_add_operation", nullptr,
                    /* description */ "Add specified operation to blacklist",
                    /* returns */ "void",
                    /* params: */{
                        {"id", "operation_type", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_blacklist_remove_operation
                hsrcore::api::MethodData delegate_blacklist_remove_operation_method_metadata{ "delegate_blacklist_remove_operation", nullptr,
            ...
            {
                // register method wallet_get_info
                hsrcore::api::MethodData wallet_get_info_method_metadata{ "wallet_get_info", nullptr,
            ...
            {
                // register method wallet_open
                hsrcore::api::MethodData wallet_open_method_metadata{ "wallet_open", nullptr,
                    /* description */ "Opens the wallet of the given name",
                    /* returns */ "void",
                    /* params: */{
                        {"wallet_name", "wallet_name", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method wallet_create
                hsrcore::api::MethodData wallet_create_method_metadata{ "wallet_create", nullptr,
                    /* description */ "Creates a wallet with the given name",
                    /* returns */ "void",
                    /* params: */{
                        {"wallet_name", "wallet_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"new_passphrase", "new_passphrase", hsrcore::api::required_positional, fc::ovariant()},
                        {"brain_key", "brainkey", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method wallet_get_name
                hsrcore::api::MethodData wallet_get_name_method_metadata{ "wallet_get_name", nullptr,
            ...
            {
                // register method wallet_import_private_key
                hsrcore::api::MethodData wallet_import_private_key_method_metadata{ "wallet_import_private_key", nullptr,
                    ...
                    /* params: */{
                        {"wif_key", "wif_private_key", hsrcore::api::required_positional, fc::ovariant()},
                        {"account_name", "account_name", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("null"))},
                        {"create_new_account", "bool", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("false"))},
                        {"rescan", "bool", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
            ...
            {
                // register method wallet_close
                hsrcore::api::MethodData wallet_close_method_metadata{ "wallet_close", nullptr,
            ...
            {
                // register method wallet_backup_create
                hsrcore::api::MethodData wallet_backup_create_method_metadata{ "wallet_backup_create", nullptr,
                    /* description */ "Exports the current wallet to a JSON file",
                    /* returns */ "void",
                    /* params: */{
                        {"json_filename", "filename", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_backup_restore
                hsrcore::api::MethodData wallet_backup_restore_method_metadata{ "wallet_backup_restore", nullptr,
                    /* description */ "Creates a new wallet from an exported JSON file",
                    /* returns */ "void",
                    /* params: */{
                        {"json_filename", "filename", hsrcore::api::required_positional, fc::ovariant()},
                        {"wallet_name", "wallet_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"imported_wallet_passphrase", "passphrase", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method wallet_set_automatic_backups
                hsrcore::api::MethodData wallet_set_automatic_backups_method_metadata{ "wallet_set_automatic_backups", nullptr,
            ...
            {
                // register method wallet_set_transaction_expiration_time
                hsrcore::api::MethodData wallet_set_transaction_expiration_time_method_metadata{ "wallet_set_transaction_expiration_time", nullptr,
                    /* description */ "Set transaction expiration time",
                    /* returns */ "uint32_t",
                    /* params: */{
                        {"seconds", "uint32_t", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_account_transaction_history
                hsrcore::api::MethodData wallet_account_transaction_history_method_metadata{ "wallet_account_transaction_history", nullptr,
                    /* description */ "Lists transaction history for the specified account",
                    /* returns */ "pretty_transactions",
                    /* params: */{
                        {"account_name", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
            ...
            {
                // register method wallet_transaction_history_splite
                hsrcore::api::MethodData wallet_transaction_history_splite_method_metadata{ "wallet_transaction_history_splite", nullptr,
                    /* description */ "Lists transaction history for the specified account",
                    /* returns */ "pretty_transactions",
                    /* params: */{
                        {"account_name", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"asset_symbol", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"limit", "int32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("0"))},
                        {"transaction_type", "int32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"2\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_account_historic_balance
                hsrcore::api::MethodData wallet_account_historic_balance_method_metadata{ "wallet_account_historic_balance", nullptr,
                    /* description */ "Lists wallet's balance at the given time",
                    /* returns */ "account_balance_summary_type",
                    /* params: */{
                        {"time", "timestamp", hsrcore::api::required_positional, fc::ovariant()},
                        {"account_name", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_remove_transaction
                hsrcore::api::MethodData wallet_remove_transaction_method_metadata{ "wallet_remove_transaction", nullptr,
                    ...
                    /* returns */ "void",
                    /* params: */{
                        {"transaction_id", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_get_pending_transaction_errors
                hsrcore::api::MethodData wallet_get_pending_transaction_errors_method_metadata{ "wallet_get_pending_transaction_errors", nullptr,
            ...
            {
                // register method wallet_lock
                hsrcore::api::MethodData wallet_lock_method_metadata{ "wallet_lock", nullptr,
            ...
            {
                // register method wallet_unlock
                hsrcore::api::MethodData wallet_unlock_method_metadata{ "wallet_unlock", nullptr,
                    /* description */ "Unlock the private keys in the wallet to enable spending operations",
                    /* returns */ "void",
                    /* params: */{
                        {"timeout", "uint32_t", hsrcore::api::required_positional, fc::ovariant()},
                        {"passphrase", "passphrase", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_change_passphrase
                hsrcore::api::MethodData wallet_change_passphrase_method_metadata{ "wallet_change_passphrase", nullptr,
                    /* description */ "Change the password of the current wallet",
                    /* returns */ "void",
                    /* params: */{
                        {"old_passphrase", "passphrase", hsrcore::api::required_positional, fc::ovariant()},
                        {"passphrase", "passphrase", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_check_passphrase
                hsrcore::api::MethodData wallet_check_passphrase_method_metadata{ "wallet_check_passphrase", nullptr,
            ...
            {
                // register method wallet_check_address
                hsrcore::api::MethodData wallet_check_address_method_metadata{ "wallet_check_address", nullptr,
            ...
            {
                // register method wallet_list
                hsrcore::api::MethodData wallet_list_method_metadata{ "wallet_list", nullptr,
            ...
            {
                // register method wallet_account_create
                hsrcore::api::MethodData wallet_account_create_method_metadata{ "wallet_account_create", nullptr,
                    /* description */ "Add new account for receiving payments",
                    /* returns */ "address",
                    /* params: */{
                        {"account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"private_data", "json_variant", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("null"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_set_approval
                hsrcore::api::MethodData wallet_account_set_approval_method_metadata{ "wallet_account_set_approval", nullptr,
                    /* description */ "Updates your approval of the specified account",
                    /* returns */ "int8_t",
                    /* params: */{
                        {"account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"approval", "int8_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("1"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_get_all_approved_accounts
                hsrcore::api::MethodData wallet_get_all_approved_accounts_method_metadata{ "wallet_get_all_approved_accounts", nullptr,
            ...
            {
                // register method wallet_address_create
                hsrcore::api::MethodData wallet_address_create_method_metadata{ "wallet_address_create", nullptr,
                    /* description */ "Creates an address which can be used for a simple (non-TITAN) transfer.",
                    /* returns */ "string",
                    /* params: */{
                        {"account_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"label", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"legacy_network_byte", "int32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_transfer_to_address
                hsrcore::api::MethodData wallet_transfer_to_address_method_metadata{ "wallet_transfer_to_address", nullptr,
                    /* description */ "Do a simple (non-TITAN) transfer to an address",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"amount_to_transfer", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "asset_symbol", hsrcore::api::required_positional, fc::ovariant()},
                        {"from_account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"to_address", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"memo_message", "information", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"strategy", "vote_strategy", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"vote_recommended\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_transfer_to_address_build
                hsrcore::api::MethodData wallet_transfer_to_address_build_method_metadata{ "wallet_transfer_to_address_build", nullptr,
                    /* description */ "create a simple (non-TITAN) transfer to an address without signature",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"amount_to_transfer", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "asset_symbol", hsrcore::api::required_positional, fc::ovariant()},
                        {"from_account_public_key", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"to_address", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"memo_message", "information", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
            ...
            {
                // register method wallet_transfer_to_public_account
                hsrcore::api::MethodData wallet_transfer_to_public_account_method_metadata{ "wallet_transfer_to_public_account", nullptr,
                    /* description */ "Sends given amount to the given account",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"amount_to_transfer", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "asset_symbol", hsrcore::api::required_positional, fc::ovariant()},
                        {"from_account_name", "sending_account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"to_account_name", "receive_account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"memo_message", "information", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"strategy", "vote_strategy", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"vote_recommended\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_withdraw_from_address
                hsrcore::api::MethodData wallet_withdraw_from_address_method_metadata{ "wallet_withdraw_from_address", nullptr,
                    /* description */ "",
            ...
            {
                // register method wallet_rescan_blockchain
                hsrcore::api::MethodData wallet_rescan_blockchain_method_metadata{ "wallet_rescan_blockchain", nullptr,
                    /* description */ "Scans the blockchain history for operations relevant to this wallet.",
                    /* returns */ "void",
                    /* params: */{
                        {"start_block_num", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("0"))},
                        {"limit", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_cancel_scan
                hsrcore::api::MethodData wallet_cancel_scan_method_metadata{ "wallet_cancel_scan", nullptr,
            ...
            {
                // register method wallet_get_transaction
                hsrcore::api::MethodData wallet_get_transaction_method_metadata{ "wallet_get_transaction", nullptr,
            ...
            {
                // register method wallet_scan_transaction
                hsrcore::api::MethodData wallet_scan_transaction_method_metadata{ "wallet_scan_transaction", nullptr,
                    /* description */ "Scans the specified transaction",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"transaction_id", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"overwrite_existing", "bool", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_rebroadcast_transaction
                hsrcore::api::MethodData wallet_rebroadcast_transaction_method_metadata{ "wallet_rebroadcast_transaction", nullptr,
            ...
            {
                // register method wallet_account_register
                hsrcore::api::MethodData wallet_account_register_method_metadata{ "wallet_account_register", nullptr,
                    /* description */ "Updates the data published about a given account",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"pay_from_account", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"public_data", "json_variant", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("null"))},
                        {"delegate_pay_rate", "uint8_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))},
                        {"account_type", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"titan_account\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_update_private_data
                hsrcore::api::MethodData wallet_account_update_private_data_method_metadata{ "wallet_account_update_private_data", nullptr,
            ...
            {
                // register method wallet_account_update_registration
                hsrcore::api::MethodData wallet_account_update_registration_method_metadata{ "wallet_account_update_registration", nullptr,
                    /* description */ "Updates the data published about a given account",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method wallet_account_update_active_key
                hsrcore::api::MethodData wallet_account_update_active_key_method_metadata{ "wallet_account_update_active_key", nullptr,
                    /* description */ "Updates the specified account's active key and broadcasts the transaction.",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"account_to_update", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"pay_from_account", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"new_active_key", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_list_accounts
                hsrcore::api::MethodData wallet_list_accounts_method_metadata{ "wallet_list_accounts", nullptr,
            ...
            {
                // register method wallet_list_unregistered_accounts
                hsrcore::api::MethodData wallet_list_unregistered_accounts_method_metadata{ "wallet_list_unregistered_accounts", nullptr,
            ...
            {
                // register method wallet_list_my_accounts
                hsrcore::api::MethodData wallet_list_my_accounts_method_metadata{ "wallet_list_my_accounts", nullptr,
            ...
            {
                // register method wallet_list_my_addresses
                hsrcore::api::MethodData wallet_list_my_addresses_method_metadata{ "wallet_list_my_addresses", nullptr,
            ...
            {
                // register method wallet_get_account
                hsrcore::api::MethodData wallet_get_account_method_metadata{ "wallet_get_account", nullptr,
                    /* description */ "Get the account entry for a given name",
            ...
            {
                // register method wallet_get_account_public_address
                hsrcore::api::MethodData wallet_get_account_public_address_method_metadata{ "wallet_get_account_public_address", nullptr,
                    /* description */ "Get the account entry for a given name",
                    /* returns */ "string",
                    /* params: */{
                        {"account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()}
            ...
            {
                // register method wallet_remove_contact_account
                hsrcore::api::MethodData wallet_remove_contact_account_method_metadata{ "wallet_remove_contact_account", nullptr,
            ...
            {
                // register method wallet_account_rename
                hsrcore::api::MethodData wallet_account_rename_method_metadata{ "wallet_account_rename", nullptr,
                    /* description */ "Rename an account in wallet",
                    /* returns */ "void",
                    /* params: */{
                        {"current_account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"new_account_name", "new_account_name", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_asset_create
                hsrcore::api::MethodData wallet_asset_create_method_metadata{ "wallet_asset_create", nullptr,
                    /* description */ "Creates a new user issued asset",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"symbol", "asset_symbol", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"issuer_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"description", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"maximum_share_supply", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"precision", "uint64_t", hsrcore::api::required_positional, fc::ovariant()},
                        {"public_data", "json_variant", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("null"))},
                        {"is_market_issued", "bool", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_asset_issue
                hsrcore::api::MethodData wallet_asset_issue_method_metadata{ "wallet_asset_issue", nullptr,
                    /* description */ "Issues new shares of a given asset type",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"amount", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"symbol", "asset_symbol", hsrcore::api::required_positional, fc::ovariant()},
                        {"to_account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"memo_message", "information", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_asset_issue_to_addresses
                hsrcore::api::MethodData wallet_asset_issue_to_addresses_method_metadata{ "wallet_asset_issue_to_addresses", nullptr,
                    /* description */ "Issues new UIA shares to specific addresses.",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"symbol", "asset_symbol", hsrcore::api::required_positional, fc::ovariant()},
                        {"addresses", "snapshot_map", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_balance
                hsrcore::api::MethodData wallet_account_balance_method_metadata{ "wallet_account_balance", nullptr,
                    /* description */ "Lists the total asset balances for the specified account",
                    /* returns */ "account_balance_summary_type",
                    /* params: */{
                        {"account_name", "account_name", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_account_balance_ids
                hsrcore::api::MethodData wallet_account_balance_ids_method_metadata{ "wallet_account_balance_ids", nullptr,
            ...
            {
                // register method wallet_account_list_public_keys
                hsrcore::api::MethodData wallet_account_list_public_keys_method_metadata{ "wallet_account_list_public_keys", nullptr,
            ...
            {
                // register method wallet_delegate_withdraw_pay
                hsrcore::api::MethodData wallet_delegate_withdraw_pay_method_metadata{ "wallet_delegate_withdraw_pay", nullptr,
                    /* description */ "Used to transfer some of the delegate's pay from their balance",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"delegate_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"to_account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"amount_to_withdraw", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_delegate_pay_balance_query
                hsrcore::api::MethodData wallet_delegate_pay_balance_query_method_metadata{ "wallet_delegate_pay_balance_query", nullptr,
            ...
            {
                // register method wallet_active_delegate_salary
                hsrcore::api::MethodData wallet_active_delegate_salary_method_metadata{ "wallet_active_delegate_salary", nullptr,
                    /* description */ "query delegate's pay balance",
            ...
            {
                // register method wallet_get_delegate_statue
                hsrcore::api::MethodData wallet_get_delegate_statue_method_metadata{ "wallet_get_delegate_statue", nullptr,
            ...
            {
                // register method wallet_set_transaction_imessage_fee_coe
                hsrcore::api::MethodData wallet_set_transaction_imessage_fee_coe_method_metadata{ "wallet_set_transaction_imessage_fee_coe", nullptr,
            ...
            {
                // register method wallet_get_transaction_imessage_fee_coe
                hsrcore::api::MethodData wallet_get_transaction_imessage_fee_coe_method_metadata{ "wallet_get_transaction_imessage_fee_coe", nullptr,
            ...
            {
                // register method wallet_set_transaction_imessage_soft_max_length
                hsrcore::api::MethodData wallet_set_transaction_imessage_soft_max_length_method_metadata{ "wallet_set_transaction_imessage_soft_max_length", nullptr,
                    /* description */ "Set imessage soft max length",
                    /* returns */ "void",
                    /* params: */{
                        {"soft_length", "amount", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_get_transaction_imessage_soft_max_length
                hsrcore::api::MethodData wallet_get_transaction_imessage_soft_max_length_method_metadata{ "wallet_get_transaction_imessage_soft_max_length", nullptr,
            ...
            {
                // register method wallet_set_transaction_fee
                hsrcore::api::MethodData wallet_set_transaction_fee_method_metadata{ "wallet_set_transaction_fee", nullptr,
            ...
            {
                // register method wallet_get_transaction_fee
                hsrcore::api::MethodData wallet_get_transaction_fee_method_metadata{ "wallet_get_transaction_fee", nullptr,
                    /* description */ "Returns ",
                    /* returns */ "asset",
                    /* params: */{
                        {"symbol", "asset_symbol", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_dump_private_key
                hsrcore::api::MethodData wallet_dump_private_key_method_metadata{ "wallet_dump_private_key", nullptr,
                    ...
                    /* params: */{
                        {"input", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_dump_account_private_key
                hsrcore::api::MethodData wallet_dump_account_private_key_method_metadata{ "wallet_dump_account_private_key", nullptr,
                    /* description */ "Reveals the specified account private key; use with caution",
                    /* returns */ "optional_string",
                    /* params: */{
                        {"account_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"key_type", "account_key_type", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_vote_summary
                hsrcore::api::MethodData wallet_account_vote_summary_method_metadata{ "wallet_account_vote_summary", nullptr,
            ...
            {
                // register method wallet_check_vote_status
                hsrcore::api::MethodData wallet_check_vote_status_method_metadata{ "wallet_check_vote_status", nullptr,
                    /* description */ "Get info about the votes of balances controlled by this account",
                    /* returns */ "vote_summary",
                    /* params: */{
                        {"account", "account_name", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_set_setting
                hsrcore::api::MethodData wallet_set_setting_method_metadata{ "wallet_set_setting", nullptr,
                    /* description */ "Set a property in the GUI settings DB",
                    /* returns */ "void",
                    /* params: */{
                        {"name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"value", "variant", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_get_setting
                hsrcore::api::MethodData wallet_get_setting_method_metadata{ "wallet_get_setting", nullptr,
            ...
            {
                // register method wallet_delegate_set_block_production
                hsrcore::api::MethodData wallet_delegate_set_block_production_method_metadata{ "wallet_delegate_set_block_production", nullptr,
            ...
            {
                // register method wallet_set_transaction_scanning
                hsrcore::api::MethodData wallet_set_transaction_scanning_method_metadata{ "wallet_set_transaction_scanning", nullptr,
            ...
            {
                // register method wallet_sign_hash
                hsrcore::api::MethodData wallet_sign_hash_method_metadata{ "wallet_sign_hash", nullptr,
            ...
            {
                // register method wallet_login_start
                hsrcore::api::MethodData wallet_login_start_method_metadata{ "wallet_login_start", nullptr,
                    /* description */ "Initiates the login procedure by providing a HSR Login URL",
                    /* returns */ "string",
                    /* params: */{
                        {"server_account", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
                    /* detailed description */ "Initiates the login procedure by providing a HSR Login URL\n\nParameters:\n  server_account (string, required): Name of the account of the server. The user will be shown this name as the site he is logging into.\n\nReturns:\n  string\n",
                    /* aliases */ {}, false};
            ...
            {
                // register method wallet_login_finish
                hsrcore::api::MethodData wallet_login_finish_method_metadata{ "wallet_login_finish", nullptr,
                    /* description */ "Completes the login procedure by finding the user's public account key and shared secret",
                    /* returns */ "variant",
                    /* params: */{
                        {"server_key", "public_key", hsrcore::api::required_positional, fc::ovariant()},
                        {"client_key", "public_key", hsrcore::api::required_positional, fc::ovariant()},
                        {"client_signature", "compact_signature", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_balance_set_vote_info
                hsrcore::api::MethodData wallet_balance_set_vote_info_method_metadata{ "wallet_balance_set_vote_info", nullptr,
                    /* description */ "Set this balance's voting address and slate",
                    /* returns */ "transaction_builder",
                    /* params: */{
                        {"balance_id", "address", hsrcore::api::required_positional, fc::ovariant()},
                        {"voter_address", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"strategy", "vote_strategy", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"vote_all\""))},
                        {"sign_and_broadcast", "bool", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"true\""))},
                        {"builder_path", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_publish_slate
                hsrcore::api::MethodData wallet_publish_slate_method_metadata{ "wallet_publish_slate", nullptr,
                    /* description */ "Publishes the current wallet delegate slate to the public data associated with the account",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"publishing_account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"paying_account_name", "account_name", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_publish_version
                hsrcore::api::MethodData wallet_publish_version_method_metadata{ "wallet_publish_version", nullptr,
            ...
            {
                // register method wallet_collect_genesis_balances
                hsrcore::api::MethodData wallet_collect_genesis_balances_method_metadata{ "wallet_collect_genesis_balances", nullptr,
            ...
            {
                // register method wallet_recover_accounts
                hsrcore::api::MethodData wallet_recover_accounts_method_metadata{ "wallet_recover_accounts", nullptr,
                    ...
                    /* returns */ "int32_t",
                    /* params: */{
                        {"accounts_to_recover", "int32_t", hsrcore::api::required_positional, fc::ovariant()},
                        {"maximum_number_of_attempts", "int32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("1000"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_verify_titan_deposit
                hsrcore::api::MethodData wallet_verify_titan_deposit_method_metadata{ "wallet_verify_titan_deposit", nullptr,
            ...
            {
                // register method wallet_repair_entrys
                hsrcore::api::MethodData wallet_repair_entrys_method_metadata{ "wallet_repair_entrys", nullptr,
                    /* description */ "tries to repair any inconsistent wallet account, key, and transaction entrys",
                    /* returns */ "void",
                    /* params: */{
                        {"collecting_account_name", "account_name", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_regenerate_keys
                hsrcore::api::MethodData wallet_regenerate_keys_method_metadata{ "wallet_regenerate_keys", nullptr,
                    /* description */ "regenerates private keys as part of wallet recovery",
                    /* returns */ "int32_t",
                    /* params: */{
                        {"account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"max_key_number", "uint32_t", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_retract
                hsrcore::api::MethodData wallet_account_retract_method_metadata{ "wallet_account_retract", nullptr,
                    /* description */ "Retract (permanently disable) the specified account in case of master key compromise.",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"account_to_retract", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"pay_from_account", "account_name", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_delete
                hsrcore::api::MethodData wallet_account_delete_method_metadata{ "wallet_account_delete", nullptr,
            ...
            {
                // register method wallet_transfer_to_address_rpc
                hsrcore::api::MethodData wallet_transfer_to_address_rpc_method_metadata{ "wallet_transfer_to_address_rpc", nullptr,
                    /* description */ "Do a simple (non-TITAN) transfer to an address",
                    /* returns */ "string",
                    /* params: */{
                        {"amount_to_transfer", "string", hsrcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method wallet_account_balance_rpc
                hsrcore::api::MethodData wallet_account_balance_rpc_method_metadata{ "wallet_account_balance_rpc", nullptr,
                    /* description */ "Lists the total asset balances for the specified account",
                    /* returns */ "string",
                    /* params: */{
                        {"account_name", "account_name", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
            ...
            {
                // register method wallet_transfer_to_public_account_rpc
                hsrcore::api::MethodData wallet_transfer_to_public_account_rpc_method_metadata{ "wallet_transfer_to_public_account_rpc", nullptr,
                    /* description */ "Sends given amount to the given account",
                    /* returns */ "string",
                    /* params: */{
                        {"amount_to_transfer", "string", hsrcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method wallet_get_account_owner_publickey
                hsrcore::api::MethodData wallet_get_account_owner_publickey_method_metadata{ "wallet_get_account_owner_publickey", nullptr,
            ...
            {
                // register method wallet_transfer_to_contract
                hsrcore::api::MethodData wallet_transfer_to_contract_method_metadata{ "wallet_transfer_to_contract", nullptr,
                    /* description */ "Do a simple transfer to a contract (name or address)",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"amount_to_transfer", "real_amount", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "asset_symbol", hsrcore::api::required_positional, fc::ovariant()},
                        {"from_account_name", "account_name", hsrcore::api::required_positional, fc::ovariant()},
                        {"to_contract", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"amount_for_exec", "real_amount", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method sign_build_transaction
                hsrcore::api::MethodData sign_build_transaction_method_metadata{ "sign_build_transaction", nullptr,
                    /* description */ "sign transaction which get from build interface",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"trasaction_building", "transaction_entry", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method broadcast_building_transaction
                hsrcore::api::MethodData broadcast_building_transaction_method_metadata{ "broadcast_building_transaction", nullptr,
            ...
            {
                // register method wallet_transfer_to_contract_build
                hsrcore::api::MethodData wallet_transfer_to_contract_build_method_metadata{ "wallet_transfer_to_contract_build", nullptr,
                    /* description */ "Do a simple transfer to a contract (name or address)",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"amount_to_transfer", "real_amount", hsrcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method wallet_transfer_to_contract_testing
                hsrcore::api::MethodData wallet_transfer_to_contract_testing_method_metadata{ "wallet_transfer_to_contract_testing", nullptr,
            ...
            {
                // register method wallet_get_contracts
                hsrcore::api::MethodData wallet_get_contracts_method_metadata{ "wallet_get_contracts", nullptr,
            ...
            {
                // register method wallet_scan_contracts
                hsrcore::api::MethodData wallet_scan_contracts_method_metadata{ "wallet_scan_contracts", nullptr,
            ...
            {
                // register method wallet_import_hshare_private_key
                hsrcore::api::MethodData wallet_import_hshare_private_key_method_metadata{ "wallet_import_hshare_private_key", nullptr,
                    /* description */ "Loads the private key into the specified account. Returns which account it was actually imported to.",
                    /* returns */ "bool",
                    /* params: */{
            ...
            {
                // register method wallet_import_hshare_encrypted_private_key
                hsrcore::api::MethodData wallet_import_hshare_encrypted_private_key_method_metadata{"wallet_import_hshare_encrypted_private_key", nullptr,
                /* description */ "Loads the encrypted private key into the specified account. Returns which account it was actually imported to.",
                /* returns */ "bool",
                /* params: */ {
            ...
            {
                // register method wallet_multisig_get_address
                hsrcore::api::MethodData wallet_multisig_get_address_method_metadata{ "wallet_multisig_get_address", nullptr,
                    /* description */ "get multisig account address",
                    /* returns */ "address",
                    /* params: */{
                        {"asset_symbol", "asset_symbol", hsrcore::api::required_positional, fc::ovariant()},
                        {"m", "uint32_t", hsrcore::api::required_positional, fc::ovariant()},
                    ...
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
                    /* detailed description */ "get multisig account address\n\nParameters:\n  asset_symbol (asset_symbol, required): which asset (string, required)\n  m (uint32_t, required): Required number of signatures (uint32_t, required)\n  addresses (address_list, required): List of possible addresses for signatures (address_list, required)\n\nReturns:\n  address\n",
                    /* aliases */ {}, false};
                store_method_metadata(wallet_multisig_get_address_method_metadata);
            }
            ...
            {
                // register method about
                hsrcore::api::MethodData about_method_metadata{ "about", nullptr,
            ...
            {
                // register method get_info
                hsrcore::api::MethodData get_info_method_metadata{ "get_info", nullptr,
                    /* description */ "Returns version number and associated information for this client",
                    /* returns */ "json_object",
                    /* params: */{                    },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method stop
                hsrcore::api::MethodData stop_method_metadata{ "stop", nullptr,
            ...
            {
                // register method help
                hsrcore::api::MethodData help_method_metadata{ "help", nullptr,
                    /* description */ "display a list of commands, or detailed help on an individual command",
                    /* returns */ "string",
                    /* params: */{
                        {"command_name", "method_name", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method validate_address
                hsrcore::api::MethodData validate_address_method_metadata{ "validate_address", nullptr,
                    /* description */ "Return information about given HSR address",
                    /* returns */ "json_object",
                    /* params: */{
                        {"address", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
                    /* detailed description */ "Return information about given HSR address\n\nParameters:\n  address (string, required): the address or public key to validate\n\nReturns:\n  json_object\n",
            ...
            {
                // register method execute_command_line
                hsrcore::api::MethodData execute_command_line_method_metadata{ "execute_command_line", nullptr,
                    /* description */ "Execute the given command as if it were typed on the CLI",
                    /* returns */ "string",
                    /* params: */{
                        {"input", "passphrase", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method execute_script
                hsrcore::api::MethodData execute_script_method_metadata{ "execute_script", nullptr,
                    /* description */ "Execute the given file as if it were typed on the CLI",
                    /* returns */ "void",
                    /* params: */{
                        {"script", "filename", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method batch
                hsrcore::api::MethodData batch_method_metadata{ "batch", nullptr,
                    ...
                    /* returns */ "variants",
                    /* params: */{
                        {"method_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"parameters_list", "parameters_list", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method batch_authenticated
                hsrcore::api::MethodData batch_authenticated_method_metadata{ "batch_authenticated", nullptr,
            ...
            {
                // register method builder_finalize_and_sign
                hsrcore::api::MethodData builder_finalize_and_sign_method_metadata{ "builder_finalize_and_sign", nullptr,
                    /* description */ "Takes a transaction builder and returns a signed transaction for broadcasting",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"builder", "transaction_builder", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 5,
            ...
            {
                // register method meta_help
                hsrcore::api::MethodData meta_help_method_metadata{ "meta_help", nullptr,
            ...
            {
                // register method rpc_set_username
                hsrcore::api::MethodData rpc_set_username_method_metadata{ "rpc_set_username", nullptr,
                    /* description */ "Set the username for basic auth for the http server.",
                    /* returns */ "void",
                    /* params: */{
                        {"username", "string", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method rpc_set_password
                hsrcore::api::MethodData rpc_set_password_method_metadata{ "rpc_set_password", nullptr,
                    /* description */ "Set the password for basic auth for the http server.",
                    /* returns */ "void",
                    /* params: */{
                        {"password", "passphrase", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method rpc_start_server
                hsrcore::api::MethodData rpc_start_server_method_metadata{ "rpc_start_server", nullptr,
                    /* description */ "Set the port and start rpc server.",
                    /* returns */ "void",
                    /* params: */{
                        {"port", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"65065\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method http_start_server
                hsrcore::api::MethodData http_start_server_method_metadata{ "http_start_server", nullptr,
                    /* description */ "Set the port and start http server.",
                    /* returns */ "void",
                    /* params: */{
                        {"port", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("\"65066\""))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method ntp_update_time
                hsrcore::api::MethodData ntp_update_time_method_metadata{ "ntp_update_time", nullptr,
            ...
            {
                // register method disk_usage
                hsrcore::api::MethodData disk_usage_method_metadata{ "disk_usage", nullptr,
            ...
            {
                // register method compile_contract
                hsrcore::api::MethodData compile_contract_method_metadata{ "compile_contract", nullptr,
                    /* description */ "compile contract source code to byte code, and store to binary file",
                    /* returns */ "filename",
                    /* params: */{
                        {"filename", "filename", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method register_contract
                hsrcore::api::MethodData register_contract_method_metadata{ "register_contract", nullptr,
                    /* description */ "register a temporary contract",
                    /* returns */ "string",
                    /* params: */{
                        {"owner", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"codefile", "filename", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"init_limit", "optional_double", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method register_contract_build
                hsrcore::api::MethodData register_contract_build_method_metadata{ "register_contract_build", nullptr,
                    /* description */ "register a temporary contract",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"owner_public_key", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"codefile", "filename", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"init_limit", "optional_double", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
                    /* detailed description */ "register a temporary contract\n\nParameters:\n  owner_public_key (string, required): contract register owner pulic key\n  codefile (filename, required): contract bytesfile name\n  asset_symbol (string, required): asset symbol name\n  init_limit (optional_double, required): the limit of asset amount used to init contract \n\nReturns:\n  transaction_entry\n",
                    /* aliases */ {}, false};
                store_method_metadata(register_contract_build_method_metadata);
            }

            {
                // register method register_contract_testing
                hsrcore::api::MethodData register_contract_testing_method_metadata{ "register_contract_testing", nullptr,
            ...
            {
                // register method upgrade_contract
                hsrcore::api::MethodData upgrade_contract_method_metadata{ "upgrade_contract", nullptr,
                    /* description */ "upgrade temporary contract to permanent contract",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"contract_address", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"upgrader_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"new_contract_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"new_contract_desc", "information", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"exec_limit", "optional_double", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method upgrade_contract_build
                hsrcore::api::MethodData upgrade_contract_build_method_metadata{ "upgrade_contract_build", nullptr,
                    /* description */ "upgrade temporary contract to permanent contract",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"contract_address", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"upgrader_public_key", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"new_contract_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"new_contract_desc", "information", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"exec_limit", "optional_double", hsrcore::api::required_positional, fc::ovariant()}
                    ...
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
                    /* detailed description */ "upgrade temporary contract to permanent contract\n\nParameters:\n  contract_address (string, required): contract address need to upgrade\n  upgrader_public_key (string, required): upgrader public key\n  new_contract_name (string, required): permanent contract name\n  new_contract_desc (information, required): permanent contract description\n  asset_symbol (string, required): symbol of asset used to destroy\n  exec_limit (optional_double, required): the limit of asset amount used to destroy contract \n\nReturns:\n  transaction_entry\n",
                    /* aliases */ {}, false};
                store_method_metadata(upgrade_contract_build_method_metadata);
            }

            {
                // register method upgrade_contract_testing
                hsrcore::api::MethodData upgrade_contract_testing_method_metadata{ "upgrade_contract_testing", nullptr,
            ...
            {
                // register method destroy_contract
                hsrcore::api::MethodData destroy_contract_method_metadata{ "destroy_contract", nullptr,
                    /* description */ "destroy temporary contract",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"contract_address", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"destroyer_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"exec_limit", "optional_double", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method destroy_contract_build
                hsrcore::api::MethodData destroy_contract_build_method_metadata{ "destroy_contract_build", nullptr,
                    /* description */ "destroy temporary contract",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"contract_address", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"destroyer_public_key", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"exec_limit", "optional_double", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
                    /* detailed description */ "destroy temporary contract\n\nParameters:\n  contract_address (string, required): contract address need to destroy\n  destroyer_public_key (string, required): destroyer name\n  asset_symbol (string, required): symbol of asset used to destroy\n  exec_limit (optional_double, required): the limit of asset amount used to destroy contract \n\nReturns:\n  transaction_entry\n",
                    /* aliases */ {}, false};
                store_method_metadata(destroy_contract_build_method_metadata);
            }

            {
                // register method destroy_contract_testing
                hsrcore::api::MethodData destroy_contract_testing_method_metadata{ "destroy_contract_testing", nullptr,
            ...
            {
                // register method call_contract
                hsrcore::api::MethodData call_contract_method_metadata{ "call_contract", nullptr,
                    /* description */ "call contract by contract name or contract address",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"contract", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"caller_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"function_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"params", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"call_limit", "optional_double", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method call_contract_build
                hsrcore::api::MethodData call_contract_build_method_metadata{ "call_contract_build", nullptr,
                    /* description */ "call contract by contract name or contract address",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"contract", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"caller_public_key", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"function_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"params", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"call_limit", "optional_double", hsrcore::api::required_positional, fc::ovariant()}
                    ...
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
                    /* detailed description */ "call contract by contract name or contract address\n\nParameters:\n  contract (string, required): contract name or contract address need to be called\n  caller_public_key (string, required): caller public key\n  function_name (string, required): function in contract \n  params (string, required): parameters which would be passed to function\n  asset_symbol (string, required): symbol of asset used to call\n  call_limit (optional_double, required): the limit of asset amount used to call contract \n\nReturns:\n  transaction_entry\n",
                    /* aliases */ {}, false};
                store_method_metadata(call_contract_build_method_metadata);
            }

            {
                // register method get_contract_info
                hsrcore::api::MethodData get_contract_info_method_metadata{ "get_contract_info", nullptr,
            ...
            {
                // register method get_contract_balance
                hsrcore::api::MethodData get_contract_balance_method_metadata{ "get_contract_balance", nullptr,
            ...
            {
                // register method call_contract_testing
                hsrcore::api::MethodData call_contract_testing_method_metadata{ "call_contract_testing", nullptr,
            ...
            {
                // register method call_contract_offline
                hsrcore::api::MethodData call_contract_offline_method_metadata{ "call_contract_offline", nullptr,
            ...
            {
                // register method load_contract_to_file
                hsrcore::api::MethodData load_contract_to_file_method_metadata{ "load_contract_to_file", nullptr,
                    /* description */ "save contract to file",
                    /* returns */ "contract_entry_printable",
                    /* params: */{
                        {"contract", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"file", "filename", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method get_result_trx_id
                hsrcore::api::MethodData get_result_trx_id_method_metadata{ "get_result_trx_id", nullptr,
                    /* description */ "get result tranraction id according to request trx id",
                    /* returns */ "transaction_id",
                    /* params: */{
                        {"request_id", "transaction_id", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method get_request_trx_id
                hsrcore::api::MethodData get_request_trx_id_method_metadata{ "get_request_trx_id", nullptr,
            ...
            {
                // register method sandbox_open
                hsrcore::api::MethodData sandbox_open_method_metadata{ "sandbox_open", nullptr,
            ...
            {
                // register method sandbox_close
                hsrcore::api::MethodData sandbox_close_method_metadata{ "sandbox_close", nullptr,
            ...
            {
                // register method sandbox_register_contract
                hsrcore::api::MethodData sandbox_register_contract_method_metadata{ "sandbox_register_contract", nullptr,
                    ...
                    /* params: */{
                        ...
                        {"codefile", "filename", hsrcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"initLimit", "optional_double", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 16,
            ...
            {
                // register method sandbox_call_contract
                hsrcore::api::MethodData sandbox_call_contract_method_metadata{ "sandbox_call_contract", nullptr,
                    ...
                    /* params: */{
                        ...
                        {"function_name", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"params", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"cost_asset", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"callLimit", "optional_double", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 16,
            ...
            {
                // register method sandbox_upgrade_contract
                hsrcore::api::MethodData sandbox_upgrade_contract_method_metadata{ "sandbox_upgrade_contract", nullptr,
            ...
            {
                // register method sandbox_upgrade_contract_testing
                hsrcore::api::MethodData sandbox_upgrade_contract_testing_method_metadata{ "sandbox_upgrade_contract_testing", nullptr,
                    /* description */ "in sandbox state: upgrade temporary contract to permanent contract",
                    /* returns */ "asset_array",
                    /* params: */{
                        {"contract_address", "string", hsrcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method sandbox_destroy_contract
                hsrcore::api::MethodData sandbox_destroy_contract_method_metadata{ "sandbox_destroy_contract", nullptr,
            ...
            {
                // register method sandbox_destroy_contract_testing
                hsrcore::api::MethodData sandbox_destroy_contract_testing_method_metadata{ "sandbox_destroy_contract_testing", nullptr,
            ...
            {
                // register method sandbox_get_contract_info
                hsrcore::api::MethodData sandbox_get_contract_info_method_metadata{ "sandbox_get_contract_info", nullptr,
            ...
            {
                // register method sandbox_get_contract_balance
                hsrcore::api::MethodData sandbox_get_contract_balance_method_metadata{ "sandbox_get_contract_balance", nullptr,
            ...
            {
                // register method sandbox_transfer_to_contract
                hsrcore::api::MethodData sandbox_transfer_to_contract_method_metadata{ "sandbox_transfer_to_contract", nullptr,
            ...
            {
                // register method sandbox_account_balance
                hsrcore::api::MethodData sandbox_account_balance_method_metadata{ "sandbox_account_balance", nullptr,
            ...
            {
                // register method sandbox_compile_contract
                hsrcore::api::MethodData sandbox_compile_contract_method_metadata{ "sandbox_compile_contract", nullptr,
            ...
            {
                // register method sandbox_load_contract_to_file
                hsrcore::api::MethodData sandbox_load_contract_to_file_method_metadata{ "sandbox_load_contract_to_file", nullptr,
            ...
            {
                // register method sandbox_register_contract_testing
                hsrcore::api::MethodData sandbox_register_contract_testing_method_metadata{ "sandbox_register_contract_testing", nullptr,
            ...
            {
                // register method sandbox_call_contract_testing
                hsrcore::api::MethodData sandbox_call_contract_testing_method_metadata{ "sandbox_call_contract_testing", nullptr,
            ...
            {
                // register method sandbox_transfer_to_contract_testing
                hsrcore::api::MethodData sandbox_transfer_to_contract_testing_method_metadata{ "sandbox_transfer_to_contract_testing", nullptr,
            ...
            {
                // register method sandbox_list_my_addresses
                hsrcore::api::MethodData sandbox_list_my_addresses_method_metadata{ "sandbox_list_my_addresses", nullptr,
            ...
            {
                // register method get_contract_registered_in_transaction
                hsrcore::api::MethodData get_contract_registered_in_transaction_method_metadata{ "get_contract_registered_in_transaction", nullptr,
                    /* description */ "get id of contract registered in specific transaction",
                    /* returns */ "string",
                    /* params: */{
                        {"trx_id", "transaction_id", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method get_transaction_id_contract_registered
                hsrcore::api::MethodData get_transaction_id_contract_registered_method_metadata{ "get_transaction_id_contract_registered", nullptr,
                    /* description */ "get id of transaction that specific contract registered in ",
                    /* returns */ "transaction_id",
                    /* params: */{
                        {"contract_id", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method get_contract_info_from_gpc_file
                hsrcore::api::MethodData get_contract_info_from_gpc_file_method_metadata{ "get_contract_info_from_gpc_file", nullptr,
            ...
            {
                // register method get_mining_info
                hsrcore::api::MethodData get_mining_info_method_metadata{ "get_mining_info", nullptr,
                    /* description */ "get mining info!",
                    /* returns */ "MiningInfo",
                    /* params: */{                    },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
                    /* detailed description */ "get mining info!\n\nParameters:\n  (none)\n\nReturns:\n  MiningInfo\n",
                    /* aliases */ {"mininginfo"}, true};
                store_method_metadata(get_mining_info_method_metadata);
            }

            {
                // register method get_difficulty
                hsrcore::api::MethodData get_difficulty_method_metadata{ "get_difficulty", nullptr,
                    /* description */ "get difficulty info!",
                    /* returns */ "MiningDifficulty",
                    /* params: */{                    },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 0,
                    /* detailed description */ "get difficulty info!\n\nParameters:\n  (none)\n\nReturns:\n  MiningDifficulty\n",
                    /* aliases */ {"difficulty"}, true};
                store_method_metadata(get_difficulty_method_metadata);
            }

            {
                // register method set_generate
                hsrcore::api::MethodData set_generate_method_metadata{ "set_generate", nullptr,
                    /* description */ "set generate!",
                    /* returns */ "bool",
                    /* params: */{
                        {"fGenerate", "bool", hsrcore::api::required_positional, fc::ovariant()},
                        {"nThreads", "uint32_t", hsrcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
                    /* detailed description */ "set generate!\n\nParameters:\n  fGenerate (bool, required): is start generate?\n  nThreads (uint32_t, optional, defaults to -1): generate block thread count\n\nReturns:\n  bool\n",
                    /* aliases */ {}, true};
                store_method_metadata(set_generate_method_metadata);
            }

            {
                // register method get_work
                hsrcore::api::MethodData get_work_method_metadata{ "get_work", nullptr,
                    /* description */ "get work for mining",
                    /* returns */ "MiningWorkPackage",
                    /* params: */{                    },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
                    /* detailed description */ "get work for mining\n\nParameters:\n  (none)\n\nReturns:\n  MiningWorkPackage\n",
                    /* aliases */ {}, true};
                store_method_metadata(get_work_method_metadata);
            }
            ...
            {
                // register method set_coinbase
                hsrcore::api::MethodData set_coinbase_method_metadata{ "set_coinbase", nullptr,
                    /* description */ "set coinbase !",
                    /* returns */ "bool",
                    /* params: */{
                        {"account_name", "std::string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
                    /* detailed description */ "set coinbase !\n\nParameters:\n  account_name (std::string, required): account name or account address!\n\nReturns:\n  bool\n",
                    /* aliases */ {}, true};
                store_method_metadata(set_coinbase_method_metadata);
            }

            {
                // register method get_staking_info
                hsrcore::api::MethodData get_staking_info_method_metadata{ "get_staking_info", nullptr,
                    /* description */ "get staking info!",
                    /* returns */ "StakingInfo",
                    /* params: */{                    },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
                    /* detailed description */ "get staking info!\n\nParameters:\n  (none)\n\nReturns:\n  StakingInfo\n",
                    /* aliases */ {}, true};
                store_method_metadata(get_staking_info_method_metadata);
            }

            {
                // register method compile_script
                hsrcore::api::MethodData compile_script_method_metadata{ "compile_script", nullptr,
            ...
            {
                // register method add_script
                hsrcore::api::MethodData add_script_method_metadata{ "add_script", nullptr,
                    /* description */ "Add a compiled script to database",
                    /* returns */ "string",
                    /* params: */{
                        {"filename", "filename", hsrcore::api::required_positional, fc::ovariant()},
                        {"description", "information", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method remove_script
                hsrcore::api::MethodData remove_script_method_metadata{ "remove_script", nullptr,
                    /* description */ "Remove a compiled script form database",
                    /* returns */ "void",
                    /* params: */{
                        {"scriptid", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method get_script_info
                hsrcore::api::MethodData get_script_info_method_metadata{ "get_script_info", nullptr,
            ...
            {
                // register method list_scripts
                hsrcore::api::MethodData list_scripts_method_metadata{ "list_scripts", nullptr,
            ...
            {
                // register method disable_script
                hsrcore::api::MethodData disable_script_method_metadata{ "disable_script", nullptr,
            ...
            {
                // register method enable_script
                hsrcore::api::MethodData enable_script_method_metadata{ "enable_script", nullptr,
            ...
            {
                // register method import_script_db
                hsrcore::api::MethodData import_script_db_method_metadata{ "import_script_db", nullptr,
                    /* description */ "import scripts from a database directory",
                    /* returns */ "void",
                    /* params: */{
                        {"dbfile", "filename", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method export_script_db
                hsrcore::api::MethodData export_script_db_method_metadata{ "export_script_db", nullptr,
            ...
            {
                // register method get_events_bound
                hsrcore::api::MethodData get_events_bound_method_metadata{ "get_events_bound", nullptr,
                    /* description */ "get contract id and event which binded with specific script",
                    /* returns */ "string_array",
                    /* params: */{
                        {"script_id", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method list_event_handler
                hsrcore::api::MethodData list_event_handler_method_metadata{ "list_event_handler", nullptr,
                    /* description */ "list all event handlers related with the specified contract id and event type",
                    /* returns */ "scriptid_list",
                    /* params: */{
                        {"contract_id_str", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"event_type", "string", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method add_event_handler
                hsrcore::api::MethodData add_event_handler_method_metadata{ "add_event_handler", nullptr,
                    ...
                    /* params: */{
                        ...
                        {"event_type", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"script_id", "string", hsrcore::api::required_positional, fc::ovariant()},
                        {"index", "uint32_t", hsrcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (hsrcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method delete_event_handler
                hsrcore::api::MethodData delete_event_handler_method_metadata{ "delete_event_handler", nullptr,
        ...
        fc::variant CommonApiRpcServer::direct_invoke_positional_method(const std::string& method_name, const fc::variants& parameters)
        {
            ...
            if (method_name == "blockchain_get_hsr_account_balance_entry")
                return blockchain_get_hsr_account_balance_entry_positional(nullptr, parameters);
            ...
            if (method_name == "wallet_import_hshare_private_key")
            ...
            if (method_name == "wallet_multisig_get_address")
                return wallet_multisig_get_address_positional(nullptr, parameters);
            ...
            if (method_name == "register_contract_build")
                return register_contract_build_positional(nullptr, parameters);
            ...
            if (method_name == "upgrade_contract_build")
                return upgrade_contract_build_positional(nullptr, parameters);
            ...
            if (method_name == "destroy_contract_build")
                return destroy_contract_build_positional(nullptr, parameters);
            ...
            if (method_name == "call_contract_build")
                return call_contract_build_positional(nullptr, parameters);
            ...
            if (method_name == "get_mining_info")
                return get_mining_info_positional(nullptr, parameters);
            if (method_name == "get_difficulty")
                return get_difficulty_positional(nullptr, parameters);
            if (method_name == "set_generate")
                return set_generate_positional(nullptr, parameters);
            if (method_name == "get_work")
            ...
            if (method_name == "get_staking_info")
                return get_staking_info_positional(nullptr, parameters);
